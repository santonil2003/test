    ...
    switch ($type) {
        ...
        case (($type >= 48) && ($type <= 72)) || (($type >= 80) && ($type <= 82)) || ($type == 88) || ($type == 87) || ($type == 85) :
            ...
            if (isset($_POST['colour']))
                $record['text2'] = $_POST['colour'];
            if (isset($_POST['material']))
                $record['text3'] = $_POST['material'];
            if (isset($_POST['design']))
                $record['text4'] = $_POST['design'];
...
//			$record['colours']				= (int)form_param('colours'); // rainbox colours
        ...
        default:
            ...
            elseif (($_POST["type"] == 14)) {
                ...
                if (( isset($_POST["reverse1"]) && $_POST["reverse1"] == "1" ) && ( (isset($_POST["firstLine1"]) && $_POST["firstLine1"] != "") || (isset($_POST["secondLine1"]) && $_POST["secondLine1"] != "") ) && ( isset($_POST["text1"]) && $_POST["text1"] != "" )) {
                    $num_reverse++;
                ...
                if (( isset($_POST["reverse2"]) && $_POST["reverse2"] == "1") && ( (isset($_POST["firstLine2"]) && $_POST["firstLine2"] != "") || (isset($_POST["secondLine2"]) && $_POST["secondLine2"] != "") ) && ( isset($_POST["text2"]) && $_POST["text2"] != "")) {
                    $num_reverse++;
                ...
                if (( isset($_POST["reverse3"]) && $_POST["reverse3"] == "1" ) && ( (isset($_POST["firstLine3"]) && $_POST["firstLine3"] != "") || (isset($_POST["secondLine3"]) && $_POST["secondLine3"] != "") ) && ( isset($_POST["text3"]) && $_POST["text3"] != "")) {
                    $num_reverse++;
                ...
                if (( isset($_POST["reverse4"]) && $_POST["reverse4"] == "1" ) && ( (isset($_POST["firstLine4"]) && $_POST["firstLine4"] != "") || (isset($_POST["secondLine4"]) && $_POST["secondLine4"] != "") ) && ( isset($_POST["text4"]) && $_POST["text4"] != "")) {
                    $num_reverse++;
            ...
            elseif ($_POST['type'] == 1 || $_POST['type'] == 16 || $_POST['type'] == 10 || $_POST['type'] == 11 || $_POST['type'] == 12) {
                ...
                $_POST["font_colour"] = isset($_POST["font_colour"]) ? $_POST["font_colour"] : 0;
            ...
            if (!$result)
                error_message(mysql_error(), 'add to order 1');
    }
}
...
function getProductPricing($productID, $currency) {
    ...
    if (!$result)
        error_message(sql_error(), 'add to order 2');
...
function insertSharedPack() {
    ...
    $result = mysql_query($query)or die(mysql_error());
    if (!$result)
        error_message(sql_error(), 'add to order 3');
}
...
if (!$result)
    error_message(sql_error(), 'add to order 4');
