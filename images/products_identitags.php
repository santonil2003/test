...
<title>identi Kid - Products - IdentiTAG</title>
                ...
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="255" bgcolor="#FFFFFF" class="maintext"> 
                        ...
                        <div align="right"><strong><img src="images/spacer_trans.gif" width="10" height="19"><? echo $prices[1];?> 

                          each, 2 for <? echo $prices[2];?><img src="images/spacer_trans.gif" width="10" height="10"><br>

                          3 for <? echo $prices[3];?> or 4 for <? echo $prices[4];?><img src="images/spacer_trans.gif" width="10" height="10"></strong></div>
...
<p><img src="images/product_IDENTITAGS_2.gif" alt="IdentiTAGS" width="356" height="610">                                </p>
                          ...
                          <tr valign="top"> 
                            ...
                            <td colspan="3"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr> 
                                  ...
                                  <td class="maintext"><p>  Make schoolbags easy to find by placing one of these great identiTAGS ! </p>

                                    <p>Fantastic big bold full colour bagtags just thread through zip ring and go. Ideal for labelling or writing on. </p>

                                    <p>Made from ultra tough PVC for hard wear and tear. </p>
                          ...
                          <tr valign="top"> 
                            ...
                            <td colspan="3" bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                                ...
                                <tr> 
                                  ...
                                  <td width="52%"><a href="order_identitags.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('add_order','','images/button_add_order_mo.gif',1)"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0"></a></td>
