                          ...
                          <tr> 
                            <td>
                                ...
                                <form name="retrievedetails" action="getcustdetails.php" method="post" onSubmit="return validateRetrieve();">
                                  ...
                                  <input type="hidden" name="postageamount" value="<? echo $postage?>">
								   <input type="hidden" name="postageoption" value="<? echo $postage_option?>">
								     <input type="hidden" name="postageenc" value="<? echo md5($postage) ?>">
                                  <input type="hidden" name="retrieve" value="1">
                                  <tr> 
                                    <td width="55%" class="smalltext">First Name:</td>
                                    <td><input type="text" name="firstname"></td>
                                  </tr>
                                  <tr> 
                                    <td width="55%" class="smalltext">Email Address:</td>
                                ...
                                <tr> 
                                  <td class="maintext"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                                  <td><img src="images/spacer_trans.gif" width="10" height="10"></td>
                                </tr><form name="form1" method="post" action="submitorder_ps.php" onSubmit="return validateForm();">
                                <input type="hidden" name="orderid" value="<? echo $id;?>">
                              <!--  <input type="hidden" name="postageamount" value="<? //echo $postage?>">
							    <input type="hidden" name="postageoption" value="<? //echo $postage_option?>">-->
                                  ...
                                  <td valign="top" class="ordertext"> 
                                    ...
                                    <?
										...
										{*/
											...
											echo '<select name="country" class="ordertext" id="country">';
										//}
...
?></select>                                    </td>
                                ...
                                <tr> 
                                  ...
                                  <td valign="top" class="ordertext"> 
                                    ...
                                    or Kindy, Shop...</font></p>
                                    <p>&nbsp;</p></td>
                                </tr>
                                <tr>
                                  <td valign="top" class="smalltext">Diacritics (special characters):</td>
                                  <td valign="top" class="ordertext"><p>If any of the names in your order have diacritics (such as &eacute;), please check the box and provide details in the Special Requirements box below.</p>
                                  <p align="center">
                                    <input name="diacriticCB" type="checkbox" id="diacriticCB" value="diacriticstrue">
                                  </p>
                                  <p align="center">If we have any difficulties we will contact you before printing the order.  </p>
                                  <p align="center">&nbsp;</p></td>
                                </tr>
                                <tr> 
                                  <td valign="top" class="smalltext">Special requirements:</td>
                                  <td valign="top" class="ordertext"> <textarea name="specialreqs" cols="25" rows="5" class="ordertext"><? echo stripslashes($specialreqs);?></textarea>                                  </td>
                                </tr>
                                <tr> 
...
?>
                                    ...
                                    &nbsp;-&nbsp; <input class="smalltext" type="text" name="vouchernumber" size="5" maxlength="3" onKeyDown="JavaScript: return(UpdateVoucherNumber(3, this));" <?=$disabled?> value="<?=$code4?>">                                  </td>
                                </tr>
                                <?
                               ...
                               <? if ($_COOKIE['currency']==1) { ?>
							    <tr>
                                  <td height="23" valign="top" class="smalltext">Postage 
                                    Option:</td>
                                  <td valign="top" class="smalltext"><font color="#FFFFFF"><? echo $cur['symbol'];?></font> <input type="text" name="postageoption" value="<? echo $postage_option;?>" readonly=""></td>
                                </tr>
								<? } ?>
                                <tr> 
                                  <td height="23" valign="top" class="smalltext">Postage 
...
if($totalprice>0){
	if($_COOKIE["currency"]==1){?>
                                    <select name="paymentmeth" class="ordertext" id="paymentmeth" onChange="disableStuff();">
                                      ...
                                      <option value="1"<? if($_POST['paymentmeth']==1){?> selected<? }?>>Credit card Now</option>
                                      <option value="4"<? if($_POST['paymentmeth']==4){?> selected<? }?>>Direct Debit via internet</option>
                                      <option value="5"<? if($_POST['paymentmeth']==5){?> selected<? }?>>Phone with C/card next business day</option>
                                      <option value="7"<? if($_POST['paymentmeth']==7){?> selected<? }?>>Paypal (payment link sent via email)</option>
                                      <option value="8"<? if($_POST['paymentmeth']==8){?> selected<? }?>>Over the Counter deposit</option>
                                      <option value="2"<? if($_POST['paymentmeth']==2){?> selected<? }?>>Money order posted next business day</option>  
                                      <option value="6"<? if($_POST['paymentmeth']==6){?> selected<? }?>>Gift Voucher (pay difference with choices above)</option>                                    
                                    </select> 
                                    <?
	}else{
		?>
...
?>                                  </td>
                                ...
                                <tr> 
                                  <td valign="top" class="smalltext" colspan="2" >
                                    All orders will only be processed once payment has been completed.<br><br>
                                    For outside australia use credit card now or paypal.<br><br>
                                    Express orders will be sent fastest payment method is credit card.
										    </td>
                                </tr>
                                <tr> 
                                  <td valign="top">&nbsp;</td>
