                      ...
                      <td colspan="5"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="70%"><div align="center"><img src="images/PAGE_PRODUCT_SHOE_DOTS.gif" alt="Shoe Dots" width="373" height="214"></div></td>
                                </tr>
                              </table>
                            ...
                            <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  ...
                                  <td class="maintext"><p> Our shoe labels are an innovative product with special adhesive for those hard to stick surfaces , sized to fit even the tiniest tots&rsquo; shoes.</p>
                                    <DIV>
                                      <ul>
                                        <li class="maintext">Approx 3cm diameter</li>
                                        <li class="maintext">No more lost shoes. </li>
                                        <li class="maintext">These cute and fun round labels help you kids identify their shoes easily! </li>
                                        <li class="maintext">Fits down to the tiny tots.</li>
                                        <li class="maintext">Clear covers to ensure no print fade with heavy wear.</li>
                                        <li class="maintext">Choose one background colour and black or white text</li>
                                      </ul>
                                    </DIV>
                                  </td>
                                </tr>
