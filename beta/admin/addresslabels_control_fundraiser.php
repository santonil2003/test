...
function newPage(){
	parent.viewer.location.href='addresslabels_labels_fundraiser.php?page='+document.forms[0].viewpage.value+'&id='+document.forms[0].id.value;
}

function GoBack(){
	parent.location.href='addresslabels_fundraiser.php?page=' + document.forms[0].viewpage.value + '&id=<? echo $invoice_numbers; ?>&startTS=<? echo $_GET["startTS"]?>&endTS=<? echo $_GET["endTS"];?>';
}
</script>
