					...
					<td align="left">
						...
						while($qdata = mysql_fetch_array($addresses)){ ?>
							<tr>
								...
								<td class="admintext" align="left"><? echo "<strong>".$qdata["firstname"]." ".$qdata["surname"]."</strong> ".stripslashes($qdata["address"]).", ".$qdata["suburb"].", ".$qdata["postcode"]." ".$qdata["state"].", ".$qdata["country"];?></td>
							</tr>
							<tr>
