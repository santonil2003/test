          ...
          <td width="418" valign="top" bgcolor="6FFF6F"> <table width="418" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      <td colspan="4"><table width="84%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          <tr bgcolor="#FFFFFF"> 
                            ...
                            <td width="67" rowspan="5" valign="top" class="smalltext"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                          </tr>
                          <tr valign="top" bgcolor="#FFFFFF"> 
                            <td colspan="3"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                          </tr>
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="89%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td valign="top"> <table width="350" border="0" cellspacing="2" cellpadding="2"><form name="form1" action="addtoorder.php" method="post">
                                      <td width="10%"> 
                                      <tr> 
                                        <td width="90%" colspan="2"><img src="images/identi_tags_choose.gif" width="340" height="380"></td>
                                      </tr>
                                      <tr> 
                                        <td colspan="2"><p align="center"><font face="Comic Sans MS">Include:&nbsp;                                              <input name="reverse" type="checkbox" onclick="dis_select(this.checked)" value="checkbox">                                             <strong><font size="2">Text on reverse                                            of tag </font></strong></font><br>
                                            <span class="style3"><font face="Comic Sans MS">**extra $4.00 charge for every IdentiTag with text </font></span></p>
                                          </td>
                                      </tr>
                                      <tr>
...
<input name="text1" type="text" id="text1" size="5"><input name="type" type="hidden" value="14"><input name="normal" type="hidden" value="yes">
