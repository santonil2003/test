              ...
              <tr valign="top"> 
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="50%" bgcolor="#FFFFFF"><h1><span class="headings"><?=$title?></td>
                      <td width="10"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                      <td width="50%" bgcolor="#FFFFFF" class="maintext"> 
                    ...
                    <tr valign="top"> 
					  ...
					  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          ...
                          <tr valign="top">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td><script type="text/javascript" src="javascript/order_coloured_ironons.js"></script></td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr valign="top"> 
