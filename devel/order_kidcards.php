              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="160" bgcolor="#FFFFFF"><h1><span class="headings">identi 
                        KIDCARDS</span></h1></td>
                      ...
                      <td colspan="4"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          <tr bgcolor="#FFFFFF"> 
                            ...
                            <td width="244" valign="top" class="smalltext"><table width="212" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  ...
                                  <td width="202" class="smalltext"><div align="left"></div></td>
                                </tr>
                              </table></td>
                          ...
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td>
								  	<script type="text/javascript" src="javascript/order_kidcards.js"></script>
								  </td>
                                </tr>
                              </table></td>
                          </tr>
