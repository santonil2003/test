...
function emailReport() {
  ...
  parent.viewer.location.href='emailReport.php?id='+document.forms[0].fundraiserChooser.value+sendString;
}
...
?>
	...
	<input type="hidden" name="yr" value="<? echo $_GET["yr"]?>">
					...
					<? }?>
					<tr>
						 <td><input type="button" value="Email current report" onClick="emailReport();">&nbsp;<input type="button" value="Print current report" onClick="parent.viewer.focus(); parent.viewer.print();">&nbsp;<img src="../images/arrow_down.gif" width="30" height="30" border="0"></td>
					</tr>
					</form>
				</table>
			</td>
