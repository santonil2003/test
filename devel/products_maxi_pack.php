...
<html>
<head>
<title>identi Kid - Products - <?= $product['productName']; ?></title>
                    ...
                    <td colspan="4">
                      <table width="100%" border=0 bgcolor="#FFFFFF">
                      	<tr>
                      		...
                      		<td valign="top"><h1 class="headings"><?= $product['productName']; ?></h1></td>
                      		<td align="right" class="maintext"><strong><?= $price_formatted; ?></strong></td>
                      		<td ><img src="images/spacer_trans.gif" width="10" height="10"></td>
                      	</tr>
                      </table>
                      </td>
                        ...
                        <!--DWLayoutTable-->
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="70%"><div align="center"><img src="images/maxi-pack-items.png" alt="Shoe Dots" width="273" height="220"></div></td>
                                </tr>
                              </table>
                          ...
                          <tr valign="top"> 
                            <td> <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                <tr> 
                                  ...
                                  <td class="maintext"><DIV>
                                    <p align="center" class="style2">Valued at over $80 -- GREAT SAVING! </p>
                                    <p align="center"><span class="style1">The pack for all occasions, labelling to the Max!</span><br>
                                      Vinyls for lunchboxes,drinkbottles and hard surface items<br>
                                      ironons for clothing, shoe dots for inside shoes.<br>
                                      ziptags for zips,laces and bagtags for bags<br>
                                      wristbands for out and about and notify others<br>
                                      of any medical conditions. <br>
                                      Packed with purpose this is the ultimate labelling pack.<br>
                                        <br>
                                        <br>
                                        <span class="style4">This pack includes:</span></p>
                                    <p align="center">Pack contains<br>
40 irons ironons semi or permanent<br>
20 large vinyls<br>
20 minis<br>
3 ziptags<br>
...
1 identitag of choice</p>
                                    <p align="center"><span class="style5">Available in Font 4 Only. <br>
                                      Any single colour choice or rainbow pack A or B<br>
                                      Shoes and ironons single colour choice only<br>
                                      Ziptags and Wristbands one design choice only.</span><br>
                                      <br>
                                      <br>
                                    </p>
                                    </DIV>                                  </td>
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="52%"><a href="order_maxi_pack.php"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0"></a></td>
                                </tr>
                              </table>
							                                <br>                                   
                              <br>
