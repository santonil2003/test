...
$order_id = $id+1000;
debug_log_add("my_order.php", "Order ID: " . $order_id);
...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr> 
                                  ...
                                  <td width="94%" valign="top" class="maintext"><?php include("_user_pages/upsell.php"); ?></td>
                                </tr>

                                <tr> 
                                  <td width="6%" valign="top" class="maintext"><img src="images/gen/spacer.gif" width="25" height="10"></td>
									<td width="94%" valign="top" class="maintext"><p>Notes:<br></p></td>
                                </tr>
                    ...
                    <tr valign="top"> 
                      <td bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                          <tr> <!-- https://echidnaweb.com.au/~identiki/-->
							...
							?>
                            <td width="52%">
							<form name="toorderform" method="post" action="/temp/order_form_ps.php">
