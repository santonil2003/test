...
<head>
	...
	<base href="http://www.identikid.com.au/" />
</head>
...
<script type="text/javascript" src="js/jquery-1.2.6.js"></script><script type="text/javascript" src="js/pos.js"></script>	
<!--<script type="text/javascript" src="js/prototype.js"></script>
<script type="text/javascript" src="js/effects.js"></script>
<script type="text/javascript" src="js/lightbox.js"></script>--><script type="text/javascript" src="js/jquery.blockUI.js"></script>	
<script type="text/javascript" src="js/interface.js"></script>
<script type="text/javascript" src="js/menu_data.js"></script>	
<script type="text/javascript" src="js/maps.js"></script>	
<script type="text/javascript" src="js/validate.js"></script>	
<script type="text/javascript" src="js/auto_iframe.js"></script>
...
if(ns4)_d.write("<scr"+"ipt type=text/javascript src=js/mmenuns4.js><\/scr"+"ipt>");		
  ...
  $(document).ready(
    ...
    var shopping_cart = function() {
          ...
          { 
            cart_loading = true;
            $("#shopping_cart").load("shopping_cart.php",
              function() {
                view_link_pos = findPos("view_order_marker");
                $("#view_order").css('position','absolute');
                $("#view_order").css('left',view_link_pos[0]+'px');
				    ...
				    if($row['section_id'] != '0' && $row['section_id'] != '1' && $row['section_id'] != '2' &&
				      ...
				      if($numPages > 2) {
	                   ...
	                   if (mysql_num_rows($result) > 0){
                        ...
                        $print_str = '<td class="breadlink"  ><a href="';
			               foreach($parents as $parent_parent) {
			                 $print_str.= str_replace(" ", "_", $parent_parent['name']);
			                 $print_str.= "/";
			               }
