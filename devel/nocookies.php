...
<p>&nbsp;</p><table width="500px" align="center">
  <tr>
			  	<td class="maintext" colspan="3"><p>To enable cookies, if you're 
        using Internet Explorer, go to<br>
        Tools &gt; Internet Options, then click the Security tab,<br>
        and move the slider to Medium-Low or Low.</p>
      <p>Once you have enables cookies, <a href="index.php">click here</a> to 
        return to Identikid</p></td>
			  </tr>
			</table>
