...
<FORM id=form1 method=post name=form1 action=add_testimonial.php>
<DIV id=form1Div>
<TABLE class=maintext border=0 cellSpacing=0 cellPadding=5 width=500>
<TBODY>
<TR>
<TD vAlign=top align=right><STRONG>Your Name:</STRONG></TD>
<TD><INPUT class=ordertext name=username size=30></TD></TR>
<TR>
<TD vAlign=top align=right><STRONG>Your Email:</STRONG></TD>
<TD><INPUT class=ordertext name=emailadd size=30 AUTOCOMPLETE="OFF"></TD></TR></TR>
<TR>
<TD vAlign=top align=right><STRONG>Post Code:</STRONG></TD>
<TD><INPUT class=ordertext name=post_code size=30 AUTOCOMPLETE="OFF"></TD></TR></TR>
<TR>
<TD vAlign=top align=right><STRONG>Country:</STRONG></TD>
<TD><INPUT class=ordertext name=country size=30 AUTOCOMPLETE="OFF"></TD></TR></TR>
<TR>
<TD vAlign=top align=right><STRONG>Date:</STRONG></TD>
<TD><INPUT class=ordertext name=date size=15> (MM/YY)</TD></TR>
<TR>
<TD vAlign=top align=right><STRONG>Your Testimonial:</STRONG></TD>
<TD><TEXTAREA cols=41 rows=5 name=testimonial></TEXTAREA></TD></TR>
<TR>
<TD>&nbsp;</TD>
<TD><INPUT id=send1 border=0 name=send1 alt=Send src="/temp/images/nav/n_send_o.gif" width=56 height=22 type=image></TD></TR></TBODY></TABLE></DIV></FORM><BR>
<H2>Testimonials</H2>
