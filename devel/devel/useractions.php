...
function getLabelType($num){
	...
	if($num==1){
		...
		return "New Baby Pack";
	}else if($num==17){
		return "Shared Pack";
	}else if($num==18){
		return "Allergy Alert Labels";
	}
	else if($num == 19)
	{
		return "	
...
function sendExpresspost($id, $name, $email) {
	...
	//		$to = "info@identikid.com.au"; 
			$to = "meredith@identikid.com.au, leanne@identikid.com.au, sean@echidnaweb.com.au"; //$_CONSTANTS['emailAdmin'];
