...
$product_name = "Thingamejigs- Extra Charms"; 
$product_type = 40;
$background_colours = array("White" => "#ffffff");
...
function update() { 
  ...
  {
    if(i != 'indexOf'){
      num_icons = Math.floor(parseInt(document.getElementById('icon_'+i).value));
...
<div width="100%" align="center">
 <div width="100%" align="center">
  <div align="center" name="items_display" id="items_display" ></div>
</div>
</td>
</tr>
<td colspan="2">
