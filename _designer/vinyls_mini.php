        ...
        <div class="designer-options">
            <div id="designer_options_details">
                ...
                <p><strong>Include: </strong>
                    ...
                    <span><input type="checkbox" checked="checked" name="details_checkbox_phone" class="details_checkbox_phone" title="Check to enable line 2" disabled="disabled"/> Line 2</span>
                ...
                <p>
                    ...
                    <input type="hidden" name="split" value="0" id="split"/>
        ...
        <div class='box-1' style='text-align:center;'>
            ...
            <div id="designer_options_quantity">
                ...
                <select id='order_quantity'>
                    ...
                    echo "<option value='$price' selected>60 Mini vinyl Labels for AU$ " . $price . "</option>";
