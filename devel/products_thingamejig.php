...
<html>
<head>
<title>identi Kid - Products - Thingamejigs-name bracelet</title>
                    ...
                    <td colspan="4">
                      <table width="100%" border=0 bgcolor="#FFFFFF">
                      	<tr>
                      		...
                      		<td valign="top"><h1 class="headings">Name Bracelet</h1></td>
                      		<td align="right" class="maintext"><strong>Bands: <?=$prices[1];?>
                        ...
                        <!--DWLayoutTable-->
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="70%"><div align="center"><img src="images/identibracelet/thingy_preview.jpg" alt="Thingamejig" width="264"></div></td>
                                </tr>
                              </table>
                            ...
                            <td> <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                <tr> 
                                  ...
                                  <td class="maintext"><DIV><p><br>
                                      The Ultimate fashion accessory for children of all ages.<br><br>
                                      <strong>A personalised name bracelet.</strong><br><br>
												  Choose the letters and pictures of your choice and the band colour and you have a fun, fashion item which is high on any kids list!<br><br>
												  What about a best friend or special gift, a birthday or even to alert someone of a special need ie allergy or diabetic.<br><br>
												  At last a practical and fashionable kids jewellery item that is comfortable to wear, safe and adjustable in size.<br>
												  Letters and charms purchased individually.<br>
												  Start a collectible craze and collect all colour bands and icons and wear them up your arm....<br>
												  more charms coming soon...<br>
                                      <br>
                                    </p>
                                    </DIV>                                  </td>
                                </tr>
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="52%"><a href="order_thingamejig.php"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0"></a></td>
                                </tr>
                              </table>
							                                <br>                                   
                              <br>
