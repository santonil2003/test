...
voucherNames[1] = new Array(15, 'Congratulations on the move');
voucherNames[2] = new Array(7, 'Merry Christmas');
voucherNames[3] = new Array(11, 'Happy Easter to a good egg');
voucherNames[4] = new Array(10, 'Happy Easter to a great chick');
voucherNames[5] = new Array(22, 'Bon Voyage');
voucherNames[6] = new Array(1, 'Welcome to the world');
...
function addVoucherToOrder(v_num) {
  ...
  voucher_html+='<br><br><img src="images/products/prod_gv_occ_'+v_num+'.gif" alt="identiKid Products - Gift Vouchers - Instant Gift Vouchers" width="122" height="214" border="0">';
...
<table border="0" cellspacing="0" cellpadding="0" width="832">
				<tr>
					...
					<img src="images/products/prod_gv_occ_1.gif" alt="identiKid Products - Gift Vouchers - Instant Gift Vouchers" width="122" height="214" border="0"><br>
					...
					<td align="center">
					<img src="images/products/prod_gv_occ_2.gif" alt="identiKid Products - Gift Vouchers - Instant Gift Vouchers" width="122" height="214" border="0"><br>
					...
					<td align="center">
					<img src="images/products/prod_gv_occ_3.gif" alt="identiKid Products - Gift Vouchers - Instant Gift Vouchers" width="122" height="214" border="0"><br>
					...
					<td><img src="images/gen/spacer.gif" width="20" height="10" alt=""><br></td>
					<td align="center">
					<img src="images/products/prod_gv_occ_4.gif" alt="identiKid Products - Gift Vouchers - Instant Gift Vouchers" width="122" height="214" border="0"><br>
					...
					<td><img src="images/gen/spacer.gif" width="20" height="10" alt=""><br></td>
					<td align="center">
					<img src="images/products/prod_gv_occ_5.gif" alt="identiKid Products - Gift Vouchers - Instant Gift Vouchers" width="122" height="214" border="0"><br>
					...
					<td><img src="images/gen/spacer.gif" width="20" height="10" alt=""><br></td>
					<td align="center">
					<img src="images/products/prod_gv_occ_6.gif" alt="identiKid Products - Gift Vouchers - Instant Gift Vouchers" width="122" height="214" border="0"><br>
					<a href="href="" onClick="addVoucherToOrder(6); return false;""><img src="images/nav/n_add_to_order.gif" alt="identi Kid Products - Add to Order" width="101" height="22" border="0"></a>
