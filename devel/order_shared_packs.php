...
<html>
<head>
<title>identi Kid - Order - Shared Packs</title>
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="160" bgcolor="#FFFFFF"><h1><span class="headings">Shared 
                        Packs</span></h1></td>
                    ...
                    <tr valign="top"> 
                      <td colspan="4"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          ...
                          <tr valign="top" bgcolor="#FFFFFF">
                            ...
                            <td width="395" colspan="3"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                            <td rowspan="4" valign="top" class="smalltext"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                          </tr>
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td><script type="text/javascript" src="javascript/order_shared_packs.js"></script></td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr valign="top"> 
