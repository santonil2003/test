...
<html>
<head>
<title>identi Kid - Products - Thingamejigs-gadget strap</title>
                    ...
                    <td colspan="4">
                      <table width="100%" border=0 bgcolor="#FFFFFF">
                      	<tr>
                      		...
                      		<td valign="top"><h1 class="headings">Gadget Strap</h1></td>
                      		<td align="right" class="maintext"><strong>Straps: <?=$prices[7];?>
                        ...
                        <!--DWLayoutTable-->
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="70%"><div align="center"><img src="images/identibracelet/gadget_preview.jpg" alt="Thingamejig" width="347"></div></td>
                                </tr>
                              </table>
...
Gadget Straps - Whether it be a phone, ipod or Tamagotchi.<br><br>
These straps suit them all. Add your name and icons<br>
and make it a truly personal gift to yourself or others<br>
let you imagination run wild!<br>
Icons and letters of your choice.
                                    </p>
                                    </DIV>                                  </td>
                                </tr>
                              </table></td>
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="52%"><a href="order_thingamejig_gadget.php"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0"></a></td>
                                </tr>
                              </table>
							                                <br>                                   
                              <br>
