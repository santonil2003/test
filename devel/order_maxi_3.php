...
$_SESSION['maxi_pack2']['phoneVal'] = $_POST['phoneVal'];
$_SESSION['maxi_pack2']['picVal'] = $_POST['picVal'];
$_SESSION['maxi_pack2']['kidsName'] = $_POST['kidsName'];
$_SESSION['maxi_pack2']['kidsPhone'] = $_POST['kidsPhone'];
//$_SESSION['maxi_pack2']['kidsName'] = $_SESSION['maxi_pack1']['kidsName'];
//$_SESSION['maxi_pack2']['kidsPhone'] = $_SESSION['maxi_pack1']['kidsPhone'];
$_SESSION['maxi_pack2']['chosenPic'] = $_POST['pic'];
$_SESSION['maxi_pack2']['background_colour'] = $_POST['background_colour'];
$_SESSION['maxi_pack2']['font_colour'] = $_POST['font_colour'];
...
if($result == true)
{
	?><!--<script type="text/javascript" src="javascript/order_maxi_iron.js"></script>-->
		...
		<PARAM NAME=movie VALUE="images/order_maxi_iron.swf?kidsName=<?=$_SESSION['maxi_pack1']['kidsName']?>&kidsPhone=<?=$_SESSION['maxi_pack1']['kidsPhone']?>&picVal=<?=$_SESSION['maxi_pack1']['picVal']?>">
		<PARAM NAME=quality VALUE=high>
		<PARAM NAME=bgcolor VALUE=#FFFFFF>
		<EMBED src="images/order_maxi_iron.swf?kidsName=<?=$_SESSION['maxi_pack1']['kidsName']?>&kidsPhone=<?=$_SESSION['maxi_pack1']['kidsPhone']?>&picVal=<?=$_SESSION['maxi_pack1']['picVal']?>" quality=high bgcolor=#FFFFFF  WIDTH="350" HEIGHT="907"  NAME="prod" ALIGN="" TYPE="application/x-shockwave-flash" PLUGINSPAGE="http://www.macromedia.com/go/getflashplayer"></EMBED>
		</OBJECT>
	<?
}
else 
