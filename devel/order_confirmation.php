                        ...
                        <table width="393" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr> 
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td>&nbsp;</td>
                                  <td class="maintext"><strong>Order Confirmation 
                                    - Almost done!</strong></td>
                                  <td class="maintext"><div align="right"><a href="javascript: document.forms['confform'].submit();" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('checkout1','','images/button_check_out_mo.gif',1)"><img src="images/button_check_out.gif" name="checkout1" width="94" height="22" border="0" id="checkout1"></a></div></td>
                                </tr>
                                <tr> 
                                  <td width="4%"><img src="images/spacer_trans.gif" width="25" height="10"></td>
                                  <td width="96%" colspan="2" class="maintext"><p>Please 
                                      confirm the details of your order <br>
                                      below. If everything is correct, click the 
                                      <br>
                                      Checkout button.</p></td>
                                </tr>
                                <tr> 
                                ...
                                <tr> 
                                  <td width="4%"><img src="images/spacer_trans.gif" width="25" height="10"></td>
                                  <td width="96%" colspan="2" class="maintext"><p><em>This 
                                      page is printable</em></p></td>
                                </tr>
                                <tr> 
                                  <td><img src="images/spacer_trans.gif" width="1" height="5"></td>
                                </tr>
