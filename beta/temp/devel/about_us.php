...
<html>
<head>
<title>identi Kid - About Us</title>
...
<table width="418" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr valign="top"> 
                      <td bgcolor="6FFF6F"><div align="right"><img src="images/heading_about_us.gif" alt="About Us" width="167" height="45"></div></td>
                ...
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    <tr> 
                      ...
                      <td width="397" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td class="maintext"><strong><br>
                              identi Kid</strong>, now into its fourth year, was 
                              designed around a product that is practical, high 
                              quality, innovative and above all something that 
                              will save you time and money. 
                              <p>We started with a simple line of products and 
                                with our incredible feedback, have continued to 
                                develop a range of fun and high quality products 
                                that will help you combat your lost property problem!</p>
                              <p>The quality of all our products has been exhaustively 
                                tested and has proved perfect for everyday, long-term 
                                use.</p>
                              <p>Turnaround is 3-5 days depending on the product 
                                ordered. We endeavour to provide a personalised, 
                                individual service and above all, we care about 
                                what we do.</p>
                              <p>Reputation is our biggest asset. Our product 
                                is 100% guaranteed and we are building a successful 
                                business on what we, as mothers would want ourselves 
                                in terms of availability, quality, service and 
                                pricing and ease of use.</p>
                              <p>Thank you for taking time to visit identi Kid. 
                    ...
                    <tr valign="top"> 
                      <td bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                          <tr> 
                            ...
                            <td width="52%"><a href="javascript:history.go(-1)" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('back','','images/button_back_mo.gif',1)"><img src="images/button_back.gif" alt="Back" name="back" width="94" height="22" border="0"></a></td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr> 
