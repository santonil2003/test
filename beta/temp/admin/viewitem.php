	...
	<tr> 
        ...
        <tr class="noshow"> 
         <!-- <td align=center colspan=3><input type="button" onClick="history.go();document.location='orders_admin.php?startrecord=<? echo $startrecord;?>&showperpage=<? echo $showperpage;?>';" value="Back"> -->
		  <td align=center colspan=3><input type="button" onClick="window.location='orders_admin.php?startrecord=<? echo $startrecord;?>&showperpage=<? echo $showperpage;?>'" value="Back"> 
		...
		<tr>
			<td align="right" colspan="3">
				<form action="updateorderstatus.php" name="frmorderstatus" id="frmorderstatus" method="post">
					<input type="hidden" name="order_id" id="order_id" value="<?php echo $_REQUEST['id'];?>" />
					<label class="maintext">Current Order Status :</label>
					<select name="orderstatus" id="orderstatus">
						<option value="pending" <?php if($order_status == "pending") {echo "selected='selected'";} ?>>Pending</option>
						<option value="printed" <?php if($order_status == "printed") {echo "selected='selected'";} ?>>Printed</option>
						<option value="posted" <?php if($order_status == "posted") {echo "selected='selected'";} ?>>Posted</option>
						<option value="processing order" <?php if($order_status == "processing order") {echo "selected='selected'";} ?>>Processing Order</option>
						<option value="payment arrived" <?php if($order_status == "payment arrived") {echo "selected='selected'";} ?>>Payment Arrived</option>
					</select>
			        <input type="hidden" name="showperpage" value="<? echo $showperpage;?>">
			        <input type="hidden" name="startrecord" value="<? echo $startrecord;?>">

					<input type="submit" name="updatestatus" id="updatestatus" value="Update Order Status" />
				</form>
			</td>
		</tr>
		<?php
		$country =	strtolower(trim($country));
		   if ($country != 'australia') {
			   echo "<tr><td align=\"right\" colspan=\"2\"><b>International Order</b><br/></td><td></td></tr>";}?>
        <tr class="noshow"> 
