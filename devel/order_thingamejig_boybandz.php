                    ...
                    <tr valign="top"> 
                      ...
                      <table width="100%" border=0 bgcolor="#FFFFFF">
                      	<tr>
                      		...
                      		<td valign="top" bgcolor="#FFFFFF"><h1 class="headings">Boybandz</h1></td>
                      		<td align="right" bgcolor="#FFFFFF" class="maintext"><strong>Band: <?=$prices[6];?><br>
...
<tr>
<td colspan="2"><img src="images/spacer_trans.gif" width="30" height="30"><div align="center"><a href="products_thingamejig_boybandz.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('back','','images/button_back_mo.gif',1)"><img src="images/button_back.gif" name="back" width="94" height="22" border="0"></a> 
