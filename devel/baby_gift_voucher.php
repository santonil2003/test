...
<html>
<head>
<title>identi Kid - Order - Baby Gift Voucher</title>
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="368" bgcolor="#FFFFFF"><h1><span class="headings">New Baby Vouchers</span></h1><br>
                        <br>
                      </td>
...
<input type="hidden" name="quantdesc" value="<?=$price['unitQuant']." New Baby voucher for ".$price['symbol'].$price['price'];?>">
                            ...
                            <td width="124" valign="top" class="smalltext"><div align="right"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('add_order','','images/button_add_order_mo.gif',1)" onClick="document.addorder.submit();"></a></div></td>
                          ...
                          <tr valign="top" bgcolor="#FFFFFF"> 
                            <td colspan="3" class=maintext>Please note this voucher can only be used to purchase a <a href="./products_new_baby_pack.php">New Baby Pack</a>.</td>
                          </tr>
                          <tr valign="top" bgcolor="#FFFFFF"> 
                            <td colspan="3"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                          </tr>
