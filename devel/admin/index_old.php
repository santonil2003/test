...
<body marginheight="0" marginwidth="0" leftmargin="0" rightmargin="0" topmargin="0" bottommargin="0">
	<table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%">
		...
		<tr>
			<td class="admintext" colspan="15" align="center"><input type="button" name="addphoneorder" value="Add Phone/Fax Order" onClick="location.href='addphoneorder.php?startrecord=<? echo $startrecord;?>&showperpage=<? echo $showperpage;?>'">
			<input type="button" name="fundraisers" value="Fundraisers" onClick="location.href='fundraisers.php?startrecord=<? echo $startrecord;?>&showperpage=<? echo $showperpage;?>'">
			<input type="button" name="addresslabels" value="Address Labels" onClick="location.href='addresslabels.php?startrecord=<? echo $startrecord;?>&showperpage=<? echo $showperpage;?>'"></td>
		</tr>
		<? if($orders_search || $name_search){ ?>
		<tr>
        ...
        <?
				while($qdata = mysql_fetch_array($result)){
					...
					while($cdata = mysql_fetch_array($customer)){
						...
						if($cdata["firstname"]!="" && $cdata["confirmed"]!="unconfirmed"){
