...
?></strong></td>
		...
		<tr>
			<td><img src="../images/spacer_trans.gif" height="1" width="1" border="0"></td>
			<td colspan="9" class="admintext"><strong><? echo stripslashes($fname);?></strong><br><? echo stripslashes($address); if($abn!=""){?><br><br><strong>ABN:<? echo $abn; } ?></strong><? echo "<br><br>Code: ".$idnumber;?></td>
		</tr>
		<tr>
