			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr> 
				  ...
				  <table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <tr> 
						<td width="2%">&nbsp;</td>
						<td width="50%" valign="top" class="whitetext"><p>Place 
                          an online order of $50 or more and receive our gift/ 
                          storage box and 2 <a href="products_kidcards.php" class="type2"><strong>Identi 
                          Kidcard</strong></a> gift tags <strong>free!</strong></p>
