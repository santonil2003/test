...
if(isset($_POST['user_name']) && isset($_POST['user_password']))
{
	...
	$string = "SELECT user_id, user_name FROM user WHERE user_name = '" . addslashes(stripslashes($_POST['user_name'])) . "' AND user_password = '" . addslashes(stripslashes($_POST['user_password'])) . "'";
...
if(check_access(2, true))
{
	?>
	<tr class="maintext"> 
		<td bgcolor="#F3F3F3"><font color="#000000" size="2"><strong><a href="./fundraisers.php" class="type1">Fundraiser Commissions</a></strong></font></td> 
...
if(check_access(11, true))
{
	?>
	<tr class="maintext"> 
		<td bgcolor="#F3F3F3"><font color="#000000" size="2"><strong><a href="http://www.identikid.com.au/stats" target="_blank" class="type1">CPanel</a></strong></font></td> 
...
if(check_access(8, true))
{
	?>
										...
										<tr class="maintext"> 
											<td bgcolor="#F3F3F3"><font color="#000000" size="2"><strong><a href="competition.php" class="type1">Competition</a></strong></font></td> 
											<td><font color="#000000" size="2">$50 Voucher Winner 2006</font></td> 
										</tr>
										<tr class="maintext"> 
