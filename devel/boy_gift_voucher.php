...
<html>
<head>
<title>identi Kid - Order - Special Boy Voucher</title>
...
function twoDecimals(string){
	...
	return string;
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="368" bgcolor="#FFFFFF"><h1><span class="headings">Special Boy Vouchers</span></h1><br>
                        <br>
                      </td>
                    ...
                    <tr valign="top"> 
                      <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          <tr bgcolor="#FFFFFF"> 
                            ...
                            <td width="124" valign="top" class="smalltext"><div align="right"><a href="#" onMouseOut="MM_swapImgRestore()" onClick="checkVoucherValue();" onMouseOver="MM_swapImage('add_order','','images/button_add_order_mo.gif',1)"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0"></a></div></td>
                          ...
                          <tr valign="top"> 
                            <form name="giftbox" action="addtoorder.php" method="post">
                              <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr> 
                                    <td><p align="center"><img src="images/boy_outside.gif" alt="Special Boy Voucher" width="378" height="278"> 
                                      </p>
                                      <p align="center"> <img src="images/boy_inside.gif" alt="Special Boy Voucher" width="378" height="278"> 
                                      </p></td>
                                  </tr>
                                </table></td>
                            </form>
