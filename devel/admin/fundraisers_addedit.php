...
if($_GET["error"]!=""){
   ...
   $contactcheque = $_GET["contactcheque"];
	$abn = $_GET["abn"];
				...
				<tr>
					...
					<td>
						...
						<table cellpadding="0" cellspacing="0" border="0">
							...
							if($_GET["success"]!=""){ ?>
							<tr>
								<td colspan="3" align="center" class="admintext"><strong>The update was successfully recorded</strong></td>
							</tr>
							<tr>
								<td><img src="../images/spacer_trans.gif" height="5" width="1" border="0"></td>
							</tr>
							...
							<tr class="admintext">
								...
								<td><img src="../images/spacer_trans.gif" height="1" width="1" border="0"></td>
								<td align="left"><input type="text" name="contactemail" size="20" value="<? echo $contactemail;?>"></td>
							</tr>
							<tr>
								<td><img src="../images/spacer_trans.gif" height="5" width="1" border="0"></td>
							</tr>
							<tr class="admintext">
								<td align="right">Name On Cheque:</td>
								<td><img src="../images/spacer_trans.gif" height="1" width="1" border="0"></td>
								<td align="left"><input type="text" name="contactcheque" size="20" value="<? echo $contactcheque;?>"></td>
							</tr>
							<tr>
								<td><img src="../images/spacer_trans.gif" height="5" width="1" border="0"></td>
							</tr>
	...
	?></select>
							...
							<tr class="admintext">
							  <td align="right">Percentage:</td>
								<td><img src="../images/spacer_trans.gif" height="1" width="1" border="0"></td>
								<td align="left"><input type="text" name="percentage" size="5" value="<? echo $percentage;?>" >&#37;</td>
							</tr>
							<tr>
								<td><img src="../images/spacer_trans.gif" height="5" width="1" border="0"></td>
							</tr>
