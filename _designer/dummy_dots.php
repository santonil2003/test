...
<html lang="en">
    <head>
        ...
        <link type="text/css" rel="Stylesheet" href="css/dummy_dots.css" />
        <script type="text/javascript" src="js/jquery.arctext.js"></script>
        <script type="text/javascript" src="http://www.google.com/jsapi"></script>
        <script src="js/dummy_dots.js"></script>
    </head>
    <body> 
        <script>
...
?>
        ...
        <form action="<?php echo $action;?>" method="post" target="_top" id="dummy-dots">
            ...
            <input type="hidden" name="phinc" value="1" id="phinc"/>
            ...
            <div id="designer_container">
                <div class="fixed_preview">
                    <div id="designer_preview" class="individual_preivew" style="background: url(/_designer/images/shoedots/df1e2e.png) no-repeat scroll 0% 0% transparent;">
                        ...
                        <div id="holder_preview_phone"><span class="preview_phone" ></span></div>
                    </div>
                </div>
