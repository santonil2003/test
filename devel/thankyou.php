                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    <tr> 
                      ...
                      <td width="397" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr> 
                            <td width="9%"><img src="images/pic_brochure.gif" alt="Mail" width="30" height="50"></td>
                            <td width="2%"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                            <td width="89%"><p class="maintext"><strong>Thankyou!</strong> 
                                Your brochure will be posted to you soon.</p></td>
                          </tr>
                          <? } ?>
                          <tr> 
                            <td>&nbsp;</td>
                    ...
                    <tr valign="top"> 
                      <td bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                          <tr> 
                            ...
                            <td width="52%"><a href="contact_us.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('back','','images/button_back_mo.gif',1)"><img src="images/button_back.gif" alt="Go back to previous page" name="back" width="94" height="22" border="0"></a></td>
                          </tr>
                        </table></td>
                    </tr>
                    <tr> 
