                    ...
                    <tr valign="top"> 
                      ...
                      <td width="255" bgcolor="#FFFFFF" class="maintext">
                        <table width="255" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
							<tr>
								<td align="right"><strong><? echo $price['unitQuant']." for ".$price['symbol'].$price['price']?><!--3 for AU$8--> or <? echo $price2['unitQuant']." for ".$price2['symbol'].$price2['price']?></strong><!--5 for AU$12--><br>
                              <strong><font size="2"><!--Reverse text additional-->
							  <?PHP
									...
									//echo $price['symbol'].$zip3;
							  
							  ?> 
                              <!--per tag--></font></strong></td>
                      ...
                      <td colspan="4"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          ...
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td> <script type="text/javascript" src="javascript/order_ziptags.js"></script></td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr> 
