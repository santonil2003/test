													...
													<tr>
														...
														<img src="images/gen/spacer.gif" width="1" height="5" alt=""><br>	
															...
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
								                                <tr> 
								                                  <td width="100%" class="headings"><p><strong>Thank You!</strong></p>
								                                    <p>Your Fundraiser Registration Form has been 
								                                      received. </p>
								                                    <p class="maintext">You will receive your 
								                                      fundraising kit in the next few days.</p></td>
								                                </tr>
											                    <tr valign="top"> 
												                    <td colspan="2" bgcolor="#FFFFFF" align="right"><br><a href="javascript:history.go(-1)" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('back','','images/nav/n_back_1_x.gif',1)"><img src="images/nav/n_back_1_o.gif" alt="Go back to the previous page" name="back" id="back" width="111" height="42" border="0"></a>&nbsp;&nbsp;</td>
											                    </tr>
								                              </table>
														<!-- end content-->
														<br><br>
