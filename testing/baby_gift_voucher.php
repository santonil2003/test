											...
											<img src="images/gen/spacer.gif" width="378" height="7" alt=""><br>
												<table border="0" cellspacing="0" cellpadding="0" width="378">
													<tr>
														...
														<img src="images/heads/sh_new_baby.gif" alt="" width="362" height="34" border="0"><br>
...
<input type="hidden" name="quantdesc" value="<?=$price['unitQuant']." New Baby voucher for ".$price['symbol'].$price['price'];?>">
														    ...
														    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          										<tr bgcolor="#FFFFFF"> 
																	...
																	Please note this voucher can only be used to purchase a <a href="./products_new_baby_pack.php">New Baby Pack</a>.</div></td>
										                        ...
										                        <form name="giftbox" action="addtoorder.php" method="post">
									                              <td colspan="3" bgcolor="#FFFFFF"><p align="center"><br>
																  <img src="images/baby_outside.gif" alt="Special Baby Voucher" width="362" height="266" border="0"> 
									                              </p>
									                              <p align="center"> <img src="images/baby_inside.gif" alt="Special Baby Voucher" width="362" height="266" border="0"> 
									                              </p>
																</td>
									                            </form>
															</table>
