...
if($_POST['section'] == "save")
{
	...
	{
		// save
		$string = "INSERT INTO user (user_name, user_password, user_email)
			VALUES ('{$_POST['user_name']}', '{$_POST['user_password']}', '{$_POST['user_email']}')";
		$result = mysql_query($string);
...
if($_GET['section'] == "edit")
{
	...
	if(isset($user))
	{
		...
		<tr>
			<td colspan=6 align=center><br /><strong><strong>Sections</strong></td>
		</tr>
		<?
