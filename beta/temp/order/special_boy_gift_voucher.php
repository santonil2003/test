                    ...
                    <tr valign="top"> 
                      <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          <tr bgcolor="#FFFFFF"> 
                            ...
                            <table width="514"><tr>
                            <td valign="top" class="smalltext" align="right"><div align="left">Please 
                                enter voucher value </div></td>
                            <td valign="top" class="smalltext" align="left" ><strong>$</strong><input name="price" type="text" value="0.00" size="10"> 
                              <img src="images/gen/spacer.gif" width="10" height="10"></td>
                            <td valign="top" class="smalltext"><div align="right"><a href="#" onMouseOut="MM_swapImgRestore()" onClick="checkVoucherValue();return false;" ><img src="images/nav/n_add_to_order.gif" alt="Add to Order" name="add_order" width="101" height="22" border="0"></a></div></td>
                            </tr></table></td>
