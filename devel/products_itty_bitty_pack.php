                        ...
                        <!--DWLayoutTable-->
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="70%"><div align="center"><img src="images/itty_bitty_items.gif" alt="Itty Bitty Pack" width="270" height="336"></div></td>
                                </tr>
                              </table>
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="52%"><a href="order_itty_bitty_pack.php"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0"></a></td>
                                </tr>
                              </table>
							                                <br>                                   
                              <br>
