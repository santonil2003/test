...
$query = "SELECT * FROM prices a, currencies b, product c WHERE a.productId=3 AND a.productId=c.id AND a.currencyInt=".$_COOKIE["currency"]." AND a.currencyInt=b.id";
...
<html>
<head>
<title>identi Kid - Products - Mini Vinyls</title>
<script Language="JavaScript" src="/ezytrack.js"></script> 
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<meta name="keywords" content="mini vinyl labels, label ">
<meta name="description" content="Our fun & colourful range of mini vinyl labels. Great for labelling your childrens and family belongings">
...
<table width="418" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      <td width="13"><img src="images/spacer_trans.gif" width="12" height="10"></td>
                      <td width="135" bgcolor="#FFFFFF"><h1><span class="headings">Mini Vinyls</span></h1></td>
                      <td width="65"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                      <td width="182" bgcolor="#FFFFFF" class="maintext"> 
                      ...
                      <td width="23"><img src="images/spacer_trans.gif" width="25" height="10"></td>
                    </tr>
                    <tr valign="top"> 
                      <td colspan="5"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          <tr bgcolor="#FFFFFF"> 
                            <td width="10" rowspan="12" valign="top"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                            <td width="257" valign="top" class="smalltext"> 
                              <table width="178" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="10" class="smalltext"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                                  <td width="168" class="smalltext"><div align="left">(19mm 
                                      x 50mm) </div></td>
                                </tr>
                              </table></td>
                            <td width="10" valign="top" class="smalltext"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                            <td width="131" valign="top" class="smalltext">&nbsp;</td>
                            <td width="10" rowspan="12" valign="top" class="smalltext"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                          </tr>
                          <tr valign="top" bgcolor="#FFFFFF"> 
                            <td colspan="3"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                          </tr>
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF" colspan="3"><div align="center"> 
                                <table width="120" border="0" cellspacing="0" cellpadding="0">
                                  <tr> 
                                    <td width="11"><strong><img src="images/spacer_trans.gif" width="10" height="10"></strong></td>
                                    <td width="109" class="headings"><img src="images/products_mini_vinyls.gif" alt="Mini Vinyls" width="203" height="174"></td>
                                  </tr>
                                </table>
                              </div></td>
                          </tr>
                          <tr>
                            <td colspan="3" valign="middle">
                              <div align="center"><img src="images/products_colours.gif" alt="Colours"></div></td>
                          </tr>
                          <tr valign="top"> 
...
<tr> 
                                          <td width="11"><strong><img src="images/spacer_trans.gif" width="10" height="10"></strong></td>
                                          <td width="184" class="headings">
                                            <div align="right">Actual 
                                              Size</div></td>
                                        </tr>
                                      </table>
                                    </div></td>
...
<tr> 
                                    ...
                                    <td width="371">
                                      <div align="center"><img src="images/products_mini_vinyls_actual.gif" alt="Mini Vinyls- Actual Size" width="219" height="92"></div></td>
                                  </tr>
                                </table>
                              </div></td>
                          </tr>
                            ...
                            <td colspan="3"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  ...
                                  <td class="maintext"><p><br>                                      
                                    Our range of mini vinyl labels are the same great quality as large vinyls only smaller for those smaller &ldquo;hard to label&rdquo; items.</p>
                                    <p> These small vinyl labels are very popular as childrens pencil labels also. You can use them to label any items or stationery your kids take to school.</p>
                                    <p> The size of this mini-vinyl label allows for a picture &amp; name but no phone number.</p>
                                  </td>
                                </tr>
                              </table></td>
                          </tr>
                          ...
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="52%"><a href="order_mini_vinyls.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('add_order','','images/button_add_order_mo.gif',1)"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0"></a></td>
                                </tr>
                              </table>
							                                <br>                                   
                              <br>
