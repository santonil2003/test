...
$query = "SELECT * FROM prices a, currencies b, product c WHERE a.productId=17 AND a.productId=c.id AND a.currencyInt=".$_COOKIE["currency"]." AND a.currencyInt=b.id";
...
<html>
<head>
<title>identi Kid - Products - Shared Packs</title>
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="181" bgcolor="#FFFFFF"><h1><span class="headings">Shared Packs</span></h1></td>
                      ...
                      <td width="148" bgcolor="#FFFFFF" class="maintext"> 
                        <div align="right"><strong><img src="images/spacer_trans.gif" width="10" height="19"> 
                          <? echo $price['unitQuant']." for ".$price['symbol'].$price['price']?>
                          <img src="images/spacer_trans.gif" width="20" height="10"></strong></div></td>
                    </tr>
                    <tr valign="top"> 
                      <td colspan="4"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          <tr bgcolor="#FFFFFF"> 
                            ...
                            <td width="244" valign="top"> <table width="246" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="11" class="smalltext"><strong><img src="images/spacer_trans.gif" width="10" height="10"></strong></td>
                                  <td width="235" class="smalltext"><div align="left">Share 
                                      60 labels for 2 children - 30 each</div></td>
                                </tr>
                              </table></td>
                          ...
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="70%"><div align="center"><img src="images/products_shared_packs.gif" alt="Shared Packs" width="373" height="473"></div></td>
                                </tr>
                              </table>
                          ...
                          <tr valign="top"> 
                            <td colspan="3"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  ...
                                  <td class="maintext"> identiKid is so flexible, 
                                    you can now split our mini's, vinyl's and 
                                    iron on's between 2 kids and in any combination 
                                    !<br>
                                    Choose 2 products from the examples above 
                                    , 1 for each child , and each will receive 
                                    recieve 30 labels in your choice of colour 
                                    combination.<br>
                                    ( 60 labels total )</td>
                                </tr>
                              </table></td>
                          ...
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="52%"><a href="order_shared_packs.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('add_order','','images/button_add_order_mo.gif',1)"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0"></a></td>
                                </tr>
                              </table>
							                                <br>                                   
                              <br>
