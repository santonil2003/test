...
<html>
<head>
<title>identi Kid - labels for littlies</title>
        ...
        <tr> 
          ...
          <td width="418" valign="top" bgcolor="#6FFF6F"> <table width="418" border="0" cellpadding="0" cellspacing="0" bgcolor="#6FFF6F">
              ...
              <tr valign="top" bgcolor="#66FF66"> 
                <td colspan="3" bgcolor="#6FFF6F"> <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    <tr> 
                      ...
                      <td width="397" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr> 
                            <td class="maintext"> <p><br>
                                Your friend Simon thought that you would enjoy 
                                our site. <br>
                                <a href="http://www.echidnaweb.com.au/~identiki" class="type1"><br>
                                Click here</a> to visit<strong> identi Kid<br>
                                <br>
                                </strong></p></td>
                          </tr>
                        </table></td>
                      <td width="10" rowspan="2" valign="top" bgcolor="#FFFFFF" class="smalltext"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                    </tr>
                    <tr valign="top"> 
