...
<tr>
<td style="vertical-align:top;"><strong>Shipping Type</strong></td>
<td style="vertical-align:top;"><input type="text" id="shipping" name="shipping" value="<? echo stripslashes($prod['shipping']) ?>" /></td>
</tr>
	<tr>
		<td colspan="2">&nbsp;</td>
	</tr>
