...
function listItems($startPage, $orderBy, $page)
{
	...
	$lt->rowHtml = '<tr bgcolor="#E5E5E5"><td> <p align="left">{createDate}</p></td><td> <p>{title}</p></td>
                        <td> <p align="center"><a href="employee_updates/index.php?id={id}&type=0" target="_blank">View</a></p></td>
                      </tr>';
...
<tr> 
	...
	<?php
	if($page->id=='f5')
		include("admin_nav_include.php");
	else
		include("members_nav_include.php");
	?>
		  </td>
...
<tr><td><form name="form1" method="post" action="">
                    <table width="100%" border="0" cellpadding="5">
                      <tr bgcolor="#CC0000"> 
                        <td colspan="3"> <p align="left" ><strong><font color="#FFFFFF">Employee 
