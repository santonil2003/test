...
$query = "SELECT * FROM prices a, currencies b, product c WHERE a.productId=9 AND a.productId=c.id AND a.currencyInt=".$_COOKIE["currency"]." AND a.currencyInt=b.id";
...
<html>
<head>
<title>identi Kid - Order - DIY Large</title>
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="138" bgcolor="#FFFFFF" ><h1><span class="headings">DIY Labels</span></h1></td>
                      <td width="12"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                      <td width="255" bgcolor="#FFFFFF" class="maintext"> 
                        <div align="right"><strong><img src="images/spacer_trans.gif" width="10" height="19">Large (38 x 60mm)<br><? echo $price['unitQuant']." for ".$price['symbol'].$price['price']?><img src="images/spacer_trans.gif" width="10" height="10"></strong></div>
                          ...
                          <tr bgcolor="#FFFFFF"> 
                            ...
                            <td width="244" valign="top" class="smalltext"><table width="178" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  ...
                                  <td width="168" class="smalltext"><div align="left">(38mm x 60mm)</div></td>
                                </tr>
                              </table></td>
                          ...
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
								 ...
								 WIDTH="350" HEIGHT="1170" id="prod" ALIGN="">
								  <PARAM NAME=movie VALUE="images/order_form_diy.swf?type=9&v=201004">
								  <PARAM NAME=quality VALUE=high>
								  <PARAM NAME=bgcolor VALUE=#FFFFFF>
								  <EMBED src="images/order_form_diy.swf?type=9&v=201004" quality=high bgcolor=#FFFFFF  WIDTH="350" HEIGHT="1170" NAME="prod" ALIGN=""
