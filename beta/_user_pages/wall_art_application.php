...
<P>Lay your Wall Graphics kit on floor and plan how you would like to use them. Let them sit unrolled for&nbsp;a few&nbsp;hours. Once you’ve decided your design layout, Cut each piece of the Wall Graphics&nbsp;out roughly around shape(this makes it easy to position), Remove backing paper and position onto wall.&nbsp;Apply carefully&nbsp;to a smooth, clean and dry surface.(Non teflon based paint) You can reposition it whilst clear sheet remains over graphic easily to get the perfect spot!</P>
...
<P><A href="<?php echo SITE_URL;?>Products/Wall_Art">Back to Wall Art</A></P>