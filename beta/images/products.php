              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr valign="top">
                      ...
                      <td width="33%" bgcolor="6FFF6F"><a href="javascript:history.go(-1)" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('back','','images/button_back_mo.gif',1)"><img src="images/button_back.gif" name="back" width="94" height="22" border="0"></a></td>
                ...
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="207" bgcolor="#FFFFFF" class="maintext"> <div align="right"><strong>60 
                          bright labels for $20 <img src="images/spacer_trans.gif" width="10" height="19"></strong></div></td>
                      ...
                      <td colspan="6"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                                  ...
                                  <td width="211" valign="top" class="maintext"> 
                                    <div align="left"> 
                                      <p align="right"><strong><img src="images/spacer_trans.gif" width="10" height="19">60 
                                        for $18<img src="images/spacer_trans.gif" width="10" height="10"></strong></p>
                                    </div></td>
                                  <td width="10" rowspan="5"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                                </tr>
                                <tr valign="top"> 
                                ...
                                <tr valign="top"> 
                                  ...
                                  <td width="211" valign="top" class="maintext"> 
                                    <div align="right"><strong><img src="images/spacer_trans.gif" width="10" height="19">24 
                                      for $15<img src="images/spacer_trans.gif" width="10" height="10"></strong></div></td>
                                  <td width="10" rowspan="5"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                                </tr>
                                <tr valign="top"> 
                          ...
                          <tr valign="top"> 
                            <td colspan="5"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                ...
                                <tr valign="top"> 
                                  <td width="10" rowspan="5"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                                  <td width="176" class="headings"> <strong><img src="images/spacer_trans.gif" width="10" height="10"></strong>Bag 
                                    Tags</td>
                                  <td width="10" rowspan="3"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                                  <td width="211" valign="top" class="maintext"> 
                                    <div align="left"> 
                                      <p align="right"><strong><img src="images/spacer_trans.gif" width="10" height="19">2 
                                        for $6 or 4 for $9</strong><strong><img src="images/spacer_trans.gif" width="10" height="10"></strong></p>
                                    </div></td>
                                  <td width="10" rowspan="5"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                                </tr>
                                <tr valign="top"> 
                                  <td class="smalltext"> <strong><img src="images/spacer_trans.gif" width="10" height="10"></strong>(32mm 
                                    x 105mm)</td>
                                  <td>&nbsp;</td>
                                </tr>
                                <tr valign="top"> 
                                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr> 
                                        <td valign="top"><div align="center"><img src="images/image_bag_tags_products.gif" alt="Bag Tags" width="162" height="135"></div></td>
                                      </tr>
                                      <tr> 
                                        <td valign="top"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                                      </tr>
                                  ...
                                  <td class="maintext">A laminated version of 
                                    the vinyl <br>
                                    labels.<br> <br>
                                    ...
                                    remove the labels!<br> <br>
                                    Order when ordering vinyl labels.<br> <br></td>
                                </tr>
                                <tr valign="top"> 
                                  <td colspan="3"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                                </tr>
                                <tr valign="top"> 
                                  ...
                                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      <tr> 
                                        <td width="44%"><a href="products_bag_tags.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('more_info211','','images/button_more_info_mo.gif',1)"><img src="images/button_more_info.gif" alt="More Information" name="more_info211" width="94" height="22" border="0" id="more_info2"></a></td>
                                        <td width="4%"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                                        <td width="52%"><a href="order_bag_tags.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('add_order211','','images/button_add_order_mo.gif',1)"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order211" width="94" height="22" border="0" id="add_order2"></a></td>
                                      </tr>
                                    </table></td>
                                </tr>
                                <tr valign="top"> 
                                  ...
                                  <td width="211" valign="top" class="maintext"> 
                                    <div align="left"> 
                                      <p align="right"><strong><img src="images/spacer_trans.gif" width="10" height="19">Small 
                                        (38 x 4O mm) $22<img src="images/spacer_trans.gif" width="10" height="10"><br>
                          ...
                          <tr valign="top"> 
                            <td colspan="5"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                ...
                                <tr valign="top"> 
                                  ...
                                  <td width="211" valign="top" class="maintext"> 
                                    <div align="left"> 
                                      <p align="right"><strong><img src="images/spacer_trans.gif" width="10" height="19">$50 
                                ...
                                <tr valign="top"> 
                                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr> 
                                        <td valign="top"><div align="center"><img src="images/image_starter_pack_products.gif" alt="Starter Packs" width="162" height="142"></div></td>
                                      </tr>
                                      <tr> 
                                        <td valign="top"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                                      </tr>
                                  ...
                                  <td class="maintext">40 vinyls<br>
                                    ...
                                    20 shoe labels<br>
                                    2 bagtags<br>
                                    30 mini labels or pencil pack<br> <br> <strong> 
                          ...
                          <tr valign="top"> 
                            <td colspan="5"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                ...
                                <tr valign="top"> 
                                  ...
                                  <td width="211" valign="top" class="maintext"> 
                                    <div align="left"> 
                                      <p align="right"><strong><img src="images/spacer_trans.gif" width="10" height="19">$25 
