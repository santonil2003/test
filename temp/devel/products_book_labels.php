...
$result = product_details(33, $_COOKIE['currency'], $product);
                    ...
                    <tr valign="top"> 
                      <td colspan="5"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          <tr bgcolor="#FFFFFF"> 
                            ...
                            <td valign="top"> <div align="center"><img src="images/spacer_trans.gif" width="10" height="10"><span class="maintext">Choose a colour set (white text &amp; font 4 only): </span></div></td>
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="70%"><div align="center"><img src="images/book_labels.gif" alt="Shoe Dots" width="315" height="162"></div></td>
                                </tr>
                              </table>
                            ...
                            <td> <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                <tr> 
                                  ...
                                  <td class="maintext"><DIV>
                                    <p><strong>Book Labels </strong></p>
                                    <p>Made from waterproof Vinyl with name to   write subject and class. Make back to school a breeze.........</p>
                                    <p>Colour choice pink, purple and yellow or   blue, red and lime.White print only.</p>
                                    <p> Font 4   only.</p>
                                    <p> Choose pic and add   name..</p>
                                  </DIV>
                                  </td>
                                </tr>
                              </table></td>
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="52%"><a href="order_book_labels.php"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0"></a></td>
                                </tr>
                              </table>
							                                <br>                                   
                              <br>
