...
$query = "SELECT * FROM prices a, currencies b, product c WHERE a.productId=7 AND a.productId=c.id AND a.currencyInt=".$_COOKIE["currency"]." AND a.currencyInt=b.id";
...
<html>
<head>
<title>identi Kid - Products - identi KIDCARDS</title>
<script Language="JavaScript" src="/ezytrack.js"></script> 
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<meta name="keywords" content="identi KIDCARDS, childrens cards">

<meta name="description" content="These great range of gift tags & mini cards will look great next to any present. Bright colours and wonderful pictures for you to choose.">
...
<table width="418" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      <td width="19"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                      <td width="182" bgcolor="#FFFFFF"><h1><span class="headings">identi KIDCARDS</span></h1></td>
                      <td width="10"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                      <td width="207" bgcolor="#FFFFFF" class="maintext"> 
                    ...
                    <tr valign="top"> 
                      <td colspan="4"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          <tr valign="top"> 
                            ...
                            <td width="395" colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="70%">
								  <div align="center">
								 	<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" width="379" height="311" id="products_display" align="middle">
									<param name="movie" value="images/products_display.swf" />
									<param name="quality" value="high" />
									<param name="bgcolor" value="#ffffff" />
									<embed src="images/products_display.swf" quality="high" bgcolor="#ffffff" width="379" height="311" name="products_display" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
									</object>
								  </div></td>
                                </tr>
                              </table>
                          ...
                          <tr valign="top"> 
                            <td colspan="3"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  ...
                                  <td class="maintext"><p> Big , bright and eye-catching, these gift tags top off a gift perfectly. Ideal for all ages, they look particularly stunning when teamed with plain coloured or brown paper. </p>
                                    <p>Available in packs of 12 for boys or girls and packed in our cute gift/ storage box so you&rsquo;ll always have them on hand when the next birthday comes up. </p>
                                    <p>Also a great idea as a gift itself. Perfect for posting ! </p>
                                    <p><img src="images/products_kidcards_cardcount.gif" alt="Kidcard packs include" width="366" height="180"><br>
                                      <br>
									   <? if($_COOKIE['currency']==1){?>
These are also sold individually rrp $1.95 and in packs through selected retail outlets. 
                                      <br>
                                      <br>
									  <? }?>
                                      <a href="stockists.php" class="type1">Click 
                                    here to find your closest stockist.</a></p></td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr valign="top"> 
                          ...
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="52%"><a href="order_kidcards.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('add_order','','images/button_add_order_mo.gif',1)"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0"></a></td>
                                </tr>
                              </table>
							                                <br>                                   
                              <br>
