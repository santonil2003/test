...
if($result == true)
{
	?>
								 ...
								 WIDTH="350" HEIGHT="1100"  id="prod" ALIGN="">
                                      <PARAM NAME=movie VALUE="images/order_shoe_dots.swf">
								  <PARAM NAME=quality VALUE=high>
								  <PARAM NAME=bgcolor VALUE=#FFFFFF>
								  <EMBED src="images/order_shoe_dots.swf" quality=high bgcolor=#FFFFFF  WIDTH="350" HEIGHT="1100" NAME="prod" ALIGN=""
