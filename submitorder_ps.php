...
if($submittype=="unconfirmed"){
	...
	// Paypal processing
	sendNewOrder($id, $_POST["firstname"]." ".$_POST["surname"], $_POST["emailadd"], $payment);
	header("location:order_payment_paypal.php?orderid=".$id);//"&postageamount=".$postage."&postageoption=".$postage_option);
...
function redira(){
this.setTimeout("redir()",500);
}
function redir(){

document.location.href='secure_forwarded.php';
}
...
<form id="toSecure" name="toSecure" action="<?=$_LINKS['secure']?>" method="post" target="_blank" onsubmit="javascript:redira();"> 
...
?>
													...
													<tr>
														...
														<td colspan="3" align="right" class="maintext"><!--<a href="javascript:openSecureWindow(document.toSecure);" class="type1" ><img name="submitimg" id="submitimg" src="images/nav/n_continue_o.gif" border="0"></a>-->  <input type="image" src="images/nav/n_continue_o.gif" name="submit"  /> &nbsp;&nbsp;&nbsp;&nbsp;</td> 
													</tr>
													<tr>
														<td>&nbsp;</td>
													</tr>
