                    ...
                    <tr valign="top"> 
                      <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          <tr bgcolor="#FFFFFF"> 
                            ...
                            <td width="124" valign="top" class="smalltext"><div align="right"><a href="#" onClick="checkVoucherValue(); return false;" ><img src="images/nav/n_add_to_order.gif" alt="Add to Order" name="add_order" width="101" height="22" border="0"></a></div></td>
                            </td></tr></table></td>
