...
<html>
<head>
<title>identi Kid - Products - Thingamejigs-boybandz</title>
                    ...
                    <td colspan="4">
                      <table width="100%" border=0 bgcolor="#FFFFFF">
                      	<tr>
                      		...
                      		<td valign="top"><h1 class="headings">Boybandz</h1></td>
                      		<td align="right" class="maintext"><strong>Bands: <?=$prices[6];?>
                        ...
                        <!--DWLayoutTable-->
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="70%"><div align="center"><img src="images/identibracelet/boybandz_preview.jpg" alt="Thingamejig" width="347"></div></td>
                                </tr>
                              </table>
...
Boybandz - So cool, funky boyz bracelets.<br><br>
This black leather band accomodates letters<br>
and icons fot those older boyz that are hard to buy for .<br>
New icons are being added regularly so keep checking back.<br>
Design it to suit there personality and style!                                    
                                      <br>
                                    </p>
                                    </DIV>                                  </td>
                                </tr>
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="52%"><a href="order_thingamejig_boybandz.php"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0"></a></td>
                                </tr>
                              </table>
							                                <br>                                   
                              <br>
