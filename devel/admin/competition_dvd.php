	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%">
        ...
        <tr> 
          <td height="38" colspan="15" valign="middle" class="admintext" align=left>
              ...
              <table width="100%" style="border: black 1px solid;" cellspacing="0" cellpadding="5" bgcolor="#FFFFFF">
			 <?
			 if(isset($_POST['Submit'])){
				...
				$tr_count = (int)($rowcount / $show_columns);
				//$tr_count = 5;
				...
				for($r=1;$r<=$tr_count;$r++)
				{
					...
					for($c=1;$c<=$show_columns;$c++)
					{
							...
							<td style="border: black 1px solid; font-size: 10pt;" align="center" width="<?=(int)(100/$show_columns)?>%"><?=$row['id']?><br><?=$row['firstname']?> <?=$row['surname']?></td>
							<?
					}
					?></tr><?
				}
