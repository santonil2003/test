						...
						<EMBED src="<? echo $aim;?>images/display_coloured_ironon.swf<? echo $swfstring;?>"
						 ...
						 TYPE="application/x-shockwave-flash" PLUGINSPAGE="<? echo $pluginspace;?>"></EMBED>
						  ...
						  <?php
								...
								<?php }else if($qdata["type"]==10 && $qdata["basketid"] > 58159){ // Starter Packs
											$width = "300";
											$height = "100";
											if($from=="admin"){
											$width*=2;
									...
									<?php	
									}else if($qdata["type"]==10 && $qdata["basketid"] < 58159){
										$width = "300";
										$height = "100";
										if($from=="admin"){
											$width*=2;
			...
			<tr> 
				...
				<?	}
					...
					?>
						<tr>
							<td width="22%" class="maintext" align="left"><strong>Product:</strong></td>
							<td width="66%" class="maintext" align="left">&nbsp;&nbsp;Additional Costing</td>
						</tr>
						<tr>
							<td width="22%" class="maintext" align="left"><strong>Reason:</strong></td>
							<td width="66%" class="maintext" align="left">&nbsp;&nbsp;<? echo $qdata["text1"];?></td>
						</tr>
					<?php
...
//						debug_showvar($qdata);
				...
				<?	}
						...
						<?
						 ...
						 if($qdata["type"]!=13 && $qdata["type"]!=14 && $qdata["type"]!="15" && $qdata['type']!=18 && $qdata['type']!=19 && $qdata['type']!=20 && $qdata['type']!=28 && $qdata['type']!=29){
							?>
							<tr> 
						...
						if($qdata["type"]!=7 && $qdata["type"]!=13 && $qdata["type"]!=14 && $qdata["type"]!="15" && $qdata['type']!=18 && $qdata['type']!=16)
						{
							?>
							<tr> 
							  <td class="maintext">Pic:</td>
									...
									if ($qdata['text3'] == 2)
									{
										db_get_field("SELECT data_colour_name FROM data_colour WHERE data_colour_id="
										 ...
										 if ((int)$qdata['text5'] == 1)
											...
											$fcolour = "White";
										echo '<tr><td class="maintext">Colour:</td>
											  <td class="maintext">'.$colour_name.'</tr>';
										echo '<tr><td></td><td class="maintext">Font Colour:</td>
											  <td></td><td class="maintext">'.$fcolour.'</tr>';
									}
							?>
