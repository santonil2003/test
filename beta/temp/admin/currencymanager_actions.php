...
function updatepostagegift(){
	...
	for($j=0; $j<count($curr); $j++){
		$query = "UPDATE currencies SET postage=".$_POST["p".$curr[$j]['id']].", expresspost=".$_POST["po".$curr[$j]['id']].", freeGift=".$_POST["g".$curr[$j]['id']].", minimumOrder=".$_POST["m".$curr[$j]['id']].", fundraisers=".((isset($_POST["f".$curr[$j]['id']]))?"1":"0")." WHERE id=".$curr[$j]['id'];
