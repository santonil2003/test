	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%">
        ...
        <tr> 
          <td height="38" colspan="15" valign="middle" class="admintext" align=left>
						...
						<p><form action="competition_winner.php" method="post" enctype="multipart/form-data" name="form1">
                <table width="100%" border="0" cellspacing="0" cellpadding="5">
                  ...
                  <tr> 
                    <td><input type="submit" name="Submit" value="Draw Winner">
                      <br>
...
<tr> 
                ...
                <?php 
			  	// past winners
			  	$sql = "SELECT * FROM competition_winners";
