<?PHP include("header.php"); ?>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td><img src="images/bread/sn_health_vouchers_x.gif" alt="identi Kid Products - Gift Vouchers - Health Vouchers" name="sn_health" id="sn_health" width="106" height="28" border="0"></td>
					<td><img src="images/bread/sn_divider.gif" alt="" width="19" height="28" border="0"></td>
					<td><a href="prod_gv_birthday.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('sn_birthday','','images/bread/sn_birthday_vouchers_x.gif',1);"><img src="images/bread/sn_birthday_vouchers_o.gif" alt="identi Kid Products - Gift Vouchers - Birthday & Any Occasion Vouchers" name="sn_birthday" id="sn_birthday" width="224" height="28" border="0"></a></td>					
				</tr>
			</table>	
			<img src="images/gen/spacer.gif" width="1" height="30" alt=""><br>
			<img src="images/products/head_gv_health.gif" width="344" height="43" alt=""><br>
