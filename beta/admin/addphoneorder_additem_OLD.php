...
function insertItem(){
	...
	case 34: // Maxi Pack
		...
		$record['text4']				= $_POST['maxi_pack1_background_colour'].",".$_POST['maxi_pack1_background_colour'].",8,".$_POST['maxi_pack2_background_colour'].",".$_POST['maxi_pack3_background_colour'];
