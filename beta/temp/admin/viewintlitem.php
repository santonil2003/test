	...
	<tr> 
        ...
        <tr class="noshow"> 
         <!-- <td align=center colspan=3><input type="button" onClick="history.go();document.location='orders_admin.php?startrecord=<? echo $startrecord;?>&showperpage=<? echo $showperpage;?>';" value="Back"> -->
		  <td align=center colspan=3><input type="button" onClick="window.location='orders_intl_admin.php?startrecord=<? echo $startrecord;?>&showperpage=<? echo $showperpage;?>'" value="Back"> 
