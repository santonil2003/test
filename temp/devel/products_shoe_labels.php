...
<html>
<head>
<title>identi Kid - Products - Shoe Labels</title>
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="212" bgcolor="#FFFFFF"><h1><span class="headings">Shoe Labels</span></h1></td>
                      ...
                      <td colspan="5"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          <tr bgcolor="#FFFFFF"> 
                            ...
                            <td width="244" valign="top"> <table width="178" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  ...
                                  <td width="167" class="smalltext"><div align="left">(15mm 
                                      x 55mm) </div></td>
                                </tr>
                              </table></td>
                          ...
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="70%"><div align="center"><img src="images/products_shoe_labels.gif" alt="Shoe Labels" width="377" height="253"></div></td>
                                </tr>
                              </table>
                          ...
                          <tr valign="top"> 
                            <td colspan="3"> <table width="393" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td class="headings"><table width="194" border="0" cellspacing="0" cellpadding="0">
                                      <tr> 
                                        <td width="11"><strong><img src="images/spacer_trans.gif" width="10" height="10"></strong></td>
                                        <td width="177" class="headings"> <div align="right">Actual 
                                            Size</div></td>
                                      </tr>
                                    </table></td>
                                </tr>
                          ...
                          <tr valign="top"> 
                            <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="3%"><strong><img src="images/spacer_trans.gif" width="10" height="10"></strong></td>
                                  <td width="97%"><div align="center"><img src="images/products_shoe_labels_actual.gif" alt="Shoe Labels - Actual Size" width="232" height="86"></div></td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr valign="top"> 
                          ...
                          <tr valign="top"> 
                            <td colspan="3"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  ...
                                  <p> Your shoe label also comes with a clear protective label cover to ensure the print will never rub off. </p></td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr valign="top"> 
                            <td colspan="3"><img src="images/spacer_trans.gif" width="30" height="15"></td>
                          </tr>
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="52%"><a href="order_shoe_labels.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('add_order','','images/button_add_order_mo.gif',1)"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0"></a></td>
                                </tr>
                              </table>
							                                <br>                                   
                              <br>
