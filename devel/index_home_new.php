      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr> 
		  ...
		  <table width="98%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                <td colspan="2"><div align="left"><a href="products_colourmyworld_packs.php"><img src="images/colour my world web title.gif" width="293" height="186" border="0"></a></div></td>
              </tr>
              <tr> 
