...
<body marginheight="0" marginwidth="0" leftmargin="0" rightmargin="0" topmargin="0" bottommargin="0">
	<table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%">
       ...
       <tr> 
        ...
        <tr> 
          <td align="center">
            <input name="Magpie_Eyes" type="button" id="Magpie_Eyes" onClick="addItem('magpie_eyes', '<? echo $_GET["startrecord"];?>', '<? echo $_GET["showperpage"];?>');" value="Add Magpie Eyes">&nbsp;
		      <input name="Wall_art" type="button" id="Wall_art" onClick="addItem('wall_art', '<? echo $_GET["startrecord"];?>', '<? echo $_GET["showperpage"];?>');" value="Add Wall Art">&nbsp;
		      <input name="Kipiis" type="button" id="Kipiis" onClick="addItem('kipiis', '<? echo $_GET["startrecord"];?>', '<? echo $_GET["showperpage"];?>');" value="Add Kipiis">&nbsp;
		     </td>
        </tr>
        <tr> 
          <td align="center">&nbsp;</td>
        ...
        <tr> 
          <td align="center"><a style="width:50%;margin:10px 0;border:solid 1px #333;padding:3px;color: #333333;font-weight:bold;display:block;background:#dddddd; text-decoration: none;" href="orders_admin.php">Return to Order List</a></td>
        </tr>
       <tr> 
          <td><img src="../images/spacer_trans.gif" height="10" width="1" border="0"></td>
        </tr>
