	...
	<table cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
			<td class="admintext">Colours:
				...
				<br><input type="radio" name="vcolours" value="9" checked>Rainbow A&nbsp;&nbsp;<input type="radio" name="vcolours" value="10" checked>Rainbow B
				<br><input type="radio" name="vcolours" value="11" checked>Baby Blue&nbsp;&nbsp;<input type="radio" name="vcolours" value="12" checked>Baby Pink
				</td>
		</tr>
		<tr>
			<td><hr noshade></td>
		...
		<tr>
	      ...
	      &nbsp;White </strong>
	      <br><input type="radio" name="icolours" value="11" checked>Baby Blue&nbsp;&nbsp;<input type="radio" name="icolours" value="12" checked>Baby Pink
</td>
		  </tr>
		<tr>
	...
	<table cellpadding="0" cellspacing="0" border="0">
		...
		<tr>
			<td class="admintext"><b>Vinyl, Mini's & shoe dots background colour</b>
				...
				<br><input type="radio" name="colours" value="9" checked>Rainbow A&nbsp;&nbsp;<input type="radio" name="colours" value="10" checked>Rainbow B
				<br><input type="radio" name="colours" value="11" checked>Baby Blue&nbsp;&nbsp;<input type="radio" name="colours" value="12" checked>Baby Pink
				</td>
		</tr>
     ...
     <tr>
      <td height="5" colspan="2" class="admintext">
	  		<table border="0" cellpadding="0" cellspacing="0">
				...
				<!-- <tr><td colspan="2"><? background_colour_select("maxi_pack2_background_colour",false,false)?></td></tr> -->
				<tr><td>Colour:</td><td class="admintext">Same as Vinyl</td></tr>
			</table>
    </tr>
    <tr><td height="5" colspan="2" class="admintext">&nbsp;</td></tr>
    <tr><td height="5" colspan="2" class="admintext">&nbsp;</td></tr>
...
// Thingamejig Name Bands
function thingamejig_name_bracelet(){
...
$product_name = "Thingamejigs- name bracelet"; 
$product_type = 36;
$background_colours = array("Blue"=>"#00aeef","Red"=>"#ff0000","Orange"=>"#ff6600", "Pink" => "#f287b6","Lime"=>"#99c93b" );
$font_colours = array();
...
<form name="form1" action="addphoneorder_additem.php" method="post">
...
<div width="100%" align="center">
  <div align="center" style="background-image: url('../images/identibracelet/bracelet.gif');
...
<td class="maintext"><input class="maintext" type="text" size="35" name="name" id="name" onkeyup="update();" value=" "; />
</td>
<tr>
...
?>
<div class="floatleft">
  <table cellpadding="0" cellspacing="2" border="0" align="center" bgcolor="#FFFFFF">
    <tr style="padding: 0px 0px 0px 0px;text-align:center;" bgcolor="#FFFFFF">
      <td style="padding: 0px 0px 0px 0px;text-align:center;" bgcolor="#FFFFFF">
...
<tr> 
    ...
    <tr> 
      <td colspan="2"><img src="../images/spacer_trans.gif" height="5" width="1" border="0" onLoad="setup()"></td>
    </tr>
</table>
</form>
...
// Thingamejig Boybandz
function thingamejig_boybandz(){
...
// Thingamejig Pet Collars
function thingamejig_collar(){
...
// Thingamejig Gadget Straps
function thingamejig_gadget(){
...
$product_name = "Thingamejigs- gadget strap"; 
$product_type = 39;
$background_colours = array("Pink" => "#f461b8", "Blue" => "#57a8dd", "Lavender" => "#af5cb5", "Brown" => "#845e3d",  "Black" => "#000000", "Beige" => "#f3dabd");
$font_colours = array();
$icons = array('Fairy' => 'fairy.gif', 'Mermaid' => 'mermaid.gif', 'Butterfly' => 'butterfly.gif', 'Skull(black)' => 'skull_black.gif','Skull(white)' => 'skull_white.gif', 
'Frangapani(green)' => 'frangapani_green.gif', 'Frangapani(red)' => 'frangapani_red.gif','Frangapani(orange)' => 'frangapani_orange.gif','Frangapani(blue)' => 'frangapani_blue.gif',
'Frangapani(purple)' => 'frangapani_purple.gif','Frangapani(pink)' => 'frangapani_pink.gif','Frangapani(yellow)' => 'frangapani_yellow.gif',
...
<div width="100%" align="center">
 <div width="100%" align="center">
  <div align="center" style="background-image: url('../images/identibracelet/gadget.png');
  background-repeat:no-repeat;background-position:center;width:375px;height:38px;max-width:375px;" name="items_display" id="items_display" ></div>
...
<script type="text/javascript">
  ...
  <?
    ...
    if(!$result) error_message(sql_error());
    while($qdata = mysql_fetch_array($result)){
      print("items[".$qdata['id']."] = new Array('".$qdata['name']."','".$qdata['preview_img']."','".$qdata['main_img']."','".$qdata['info']."' );");
    }  
  ?>
...
<form name="form1" action="addphoneorder_additem.php" method="post">
  ...
  <div style="width:100%;text-align:center;">
    <div id="design_preview" style="background-color:white;"></div>
