...
$query = "SELECT * FROM prices a, currencies b, product c WHERE a.productId=21 AND a.productId=c.id AND a.currencyInt=".$_COOKIE["currency"]." AND a.currencyInt=b.id";
...
<html>
<head>
<title>identi Kid - Products - Colour My World Packs</title>
<script Language="JavaScript" src="/ezytrack.js"></script> 
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<meta name="keywords" content="label starter pack, begin labelling, pack of labels">
<meta name="description" content="Take care of all your labelling needs with our helpful pre-made starter packs. They're full of labels and tags, perfect for back to school books, clothes and pencils.">
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="181" bgcolor="#FFFFFF"><h1><span class="headings">Colour 
                          My World Packs</span></h1></td>
                      <td width="74"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                      <td width="148" bgcolor="#FFFFFF" class="maintext"> 
                      ...
                      <td colspan="4"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          <tr bgcolor="#FFFFFF"> 
                            ...
                            <td width="244" valign="top"> <table width="178" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  ...
                                  <td width="167" class="smalltext"><div align="left">(very 
                                      popular!!!) </div></td>
                                </tr>
                              </table></td>
                          ...
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="70%"><div align="center"><img src="images/products_colourmyworld_packs.gif" alt="Colour My World Packs" width="373" height="340"></div></td>
                                </tr>
                              </table>
                                ...
                                <tr> 
                                  ...
                                  <td class="maintext"><p> 40 vinyls <br>
                                    ...
                                    <p><strong>Conditions <br>
                                      </strong>Same name, font, picture and detail 
                                      throughout pack of labels. Rainbow set A 
                                      or B.</p>
                                    <p> A great value labelling pack to get you started. Perfect for all ages and uses. </p>
                                    <p>NOTE: When ordering a Colour My World Pack, 
                                      you only need to design the vinyl label. 
                                      We will carry the design onto all of the 
                                      other name labels in the pack. </p>
                                  </td>
                                </tr>
                              </table></td>
                          </tr>
                          ...
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="52%"><a href="order_colour_my_world_packs.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('add_order','','images/button_add_order_mo.gif',1)"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0"></a></td>
                                </tr>
                              </table>
							                                <br>                                   
                              <br>
