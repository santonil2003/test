                              ...
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td valign="top" align="center" > 
                                    <table width="820" border="0" cellspacing="2" cellpadding="2">
...
$get_tags = mysql_query("SELECT * FROM designer_identitag");
while($tagRow = mysql_fetch_array($get_tags)){
    if( in_array($tagRow['tagCode'],$picturesAr) ){
        echo "<a href='".  strtolower($tagRow['tagCode'])."' onclick='addTag(this);return false;'><img src='".$tagRow['image']."'  style='width:75px;height:75px;border:solid 1px #ddd;' /></a>";
    }
}
echo "</div>";
?>
...
<area shape="rect" coords="131,339,200,379" href="p1" onclick="addTag(this);return false;" />
<area shape="rect" coords="205,339,282,379" href="u1" onclick="addTag(this);return false;" />
</map>-->
