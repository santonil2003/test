                      ...
                      <td width="393" valign="top" bgcolor="#FFFFFF"> 
                        <table width="393" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr> 
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  ...
                                  <td width="96%" class="maintext"><strong>Unfortunately there was a problem with your transaction attempt...</strong><br><br></td>
                                </tr>
								<tr> 
                                  <td width="4%"><img src="images/spacer_trans.gif" width="25" height="10"></td>
                                  <td width="96%" class="maintext"><p>The secure payment server responded with: <? echo $_POST["STATUS"]; ?></strong><br><br>
								  Click 'Check Out' to try again.</p></td>
                                </tr>
                              </table></td>
                          </tr>
						  <tr> 
						  ...
						  <tr valign="top" colspan="3"> 
							  <td align="right"><a href="products_home.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Image21','','images/button_viewproducts_long_mo.gif',1)"><img src="images/button_viewproducts_long.gif" alt="View Products" name="Image21" width="100" height="22" border="0"></a>
							  <a href="order_form_strans_test.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('checkout','','images/button_check_out_mo.gif',1)"><img src="images/button_check_out.gif" name="checkout" width="94" height="22" border="0"></a></td>
							</tr>
                        </table>
                      </td>
