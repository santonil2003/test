...
<html>
<head>
<title>identi Kid - Order - Address Labels</title>
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="190" bgcolor="#FFFFFF"><h1><span class="headings">Address Labels  </span></h1></td>
                      <td width="8">&nbsp;</td>
                      <td width="205" bgcolor="#FFFFFF" class="maintext">
                        <table width="205" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
							<tr>
								<td align="right"><p><strong><!--3 for AU$8-->
						      </strong><strong>
                              <?= $price_formatted; ?>
                              <!--3 for AU$8-->
                              ...
                              <?= $price_formatted3; ?>
                              </STRONG><img src="images/spacer_trans.gif" alt="spacer" width="10" height="10"><br>
							  </p>							  </td>
							</tr>
						</table>
                      </td>
                            ...
                            <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
								  ...
								  <OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
									 ...
									 WIDTH="350" HEIGHT="850" ALIGN="">
<PARAM NAME=movie VALUE="flash/order_addresslabels.swf">
									  <PARAM NAME=quality VALUE=high>
									  <PARAM NAME=bgcolor VALUE=#FFFFFF>
									  <EMBED src="flash/order_addresslabels.swf" quality=high bgcolor=#FFFFFF  WIDTH="350" HEIGHT="850" ALIGN="" TYPE="application/x-shockwave-flash" PLUGINSPAGE="http://www.macromedia.com/go/getflashplayer"></EMBED> 
									</OBJECT>
								  </td>
                                </tr>
                              </table></td>
