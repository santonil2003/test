...
<html>
<head>
<title>identi Kid - Order - <?=$title?></title>
              ...
              <tr valign="top"> 
				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="160" bgcolor="#FFFFFF"><h1><span class="headings"><?=$title?></td>
                    ...
                    <tr valign="top"> 
					  ...
					  <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          <tr bgcolor="#FFFFFF"> 
                            ...
                            <td width="244" valign="top" class="smalltext"><table width="178" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  ...
                                  <td width="168" class="smalltext"><div align="left">(15mm 
                                      x 55mm) </div></td>
                                </tr>
                              </table></td>
                          ...
                          <tr valign="top">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td><script type="text/javascript" src="javascript/order_iron_labels.js"></script></td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr valign="top"> 
