...
*/
	if(mysql_num_rows($result_temp_customer_details) == 1){
		...
		$del_name = $rs_temp_customer_details["del_name"];
		...
		$address_cust = $rs_temp_customer_details["address_cust"];
		$suburb_cust = $rs_temp_customer_details["suburb_cust"];
		$postcode_cust = $rs_temp_customer_details["postcode_cust"];
		$state_cust = $rs_temp_customer_details["state_cust"];
		$country_cust = $rs_temp_customer_details["country_cust"];
		...
		$vouchercode = '';
		if(isset($_POST["vouchernumber_1"]) && $_POST["vouchernumber_1"]!=''){
		  $vouchercode = $_POST["vouchernumber_1"].','.$_POST["vouchernumber_2"].','.$_POST["vouchernumber_3"].','.$_POST["vouchernumber_4"];
		}
		$total = $_POST["total"];
	...
	<tr> 
		...
		<td align="left"> 
            ...
            <form name="confform" method="post" action="addphoneorder_submitorder_ps.php">
              ...
              <input type="hidden" name="del_name" value="<? echo $del_name;?>">
              ...
              <input type="hidden" name="address_cust" value="<? echo $address_cust;?>">
              <input type="hidden" name="suburb_cust" value="<? echo $suburb_cust;?>">
            ...
            <tr> 
              ...
              <td><img src="../images/spacer_trans.gif" width="1" height="1"></td>
              <td class="admintext"><? echo $address_cust?></td>
            </tr>
            <tr> 
              <td align="right" class="admintext"><strong>Suburb / Town / City:</strong></td>
              <td><img src="../images/spacer_trans.gif" width="1" height="1"></td>
              <td class="admintext"><? echo $suburb_cust?></td>
            </tr>
            <tr> 
              <td align="right" class="admintext"><strong>Postcode:</strong></td>
              <td><img src="../images/spacer_trans.gif" width="1" height="1"></td>
              <td class="admintext"><? echo $postcode_cust?></td>
            </tr>
            <tr> 
              <td align="right" class="admintext"><strong>State:</strong></td>
              <td><img src="../images/spacer_trans.gif" width="1" height="1"></td>
              <td class="admintext"><? echo $state_cust?></td>
            </tr>
            <tr> 
              <td align="right" class="admintext"><strong>Country:</strong></td>
              <td><img src="../images/spacer_trans.gif" width="1" height="1"></td>
              <td class="admintext"><? echo $country_cust?></td>
            </tr>
            <tr> 
              <td align="right" class="admintext"><strong>Delivery Name:</strong></td>
              <td><img src="../images/spacer_trans.gif" width="1" height="1"></td>
              <td class="admintext"><? echo $del_name?></td>
            </tr>
            <tr> 
              <td align="right" class="admintext"><strong>Delivery Address:</strong></td>
              <td><img src="../images/spacer_trans.gif" width="1" height="1"></td>
