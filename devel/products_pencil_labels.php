...
$query = "SELECT * FROM prices a, currencies b, product c WHERE a.productId=5 AND a.productId=c.id AND a.currencyInt=".$_COOKIE["currency"]." AND a.currencyInt=b.id";
...
<html>
<head>
<title>identi Kid - Products - Pencil Labels</title>
<script Language="JavaScript" src="/ezytrack.js"></script> 
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
<meta name="keywords" content="pencil label, school stationery labels">

<meta name="description" content="Our fun & colourful range of pencil labels for school children.">
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="158" bgcolor="#FFFFFF"><h1><span class="headings">Pencil Labels</span></h1></td>
                      <td width="10"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                      <td width="241" bgcolor="#FFFFFF" class="maintext"> 
                      ...
                      <td colspan="4"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          <tr bgcolor="#FFFFFF"> 
                            ...
                            <td width="244" valign="top" class="smalltext"><table width="178" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  ...
                                  <td width="168" class="smalltext"><div align="left">(9.5mm 
                                      x 50mm) </div></td>
                                </tr>
                              </table></td>
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF" colspan="3">
                                <div align="center"><img src="images/products_pencil_labels.gif" alt="Pencil Labels" width="244" height="194"></div>
                              </td>
                          </tr>
                          <tr>
                                ...
                                <tr> 
                                  <td width="186" class="headings"><div align="left"> 
                                      <table width="221" border="0" cellspacing="0" cellpadding="0">
                                        <tr> 
                                          <td width="103"><strong><img src="images/spacer_trans.gif" width="10" height="10"></strong></td>
                                          <td width="118"class="headings">Actual Size</td>
                                        </tr>
                                      </table>
                                    </div></td>
                                </tr>
                          ...
                          <tr valign="top"> 
                            <td colspan="3"><div align="left"> 
                                <table width="394" border="0" cellspacing="0" cellpadding="0">
                                  <tr> 
                                    <td width="33"><strong><img src="images/spacer_trans.gif" width="10" height="10"></strong></td>
                                    <td width="361" class="headings"> <div align="center"><img src="images/products_pencil_labels_actual.gif" alt="Pencil Labels - Actual Size" width="225" height="62"></div></td>
                                  </tr>
                                </table>
                              </div></td>
                          </tr>
                          ...
                          <tr valign="top"> 
                            <td colspan="3"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  ...
                                  <td class="maintext"><p> The easy way to stop fights over pencil ownership! These great pencil labels are pre-cut and ready to use.</p>
                                    <p> Your children will lose less school stationery if you label their pens and pencils.</p>
                                  <p> Name only, no picture, font style 4 only. </p></td>
                                </tr>
                              </table></td>
                          </tr>
                          <tr valign="top"> 
                          ...
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="52%"><a href="order_pencil_labels.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('add_order','','images/button_add_order_mo.gif',1)"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0"></a></td>
                                </tr>
                              </table>
							                                <br>                                   
                              <br>
