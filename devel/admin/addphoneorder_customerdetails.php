...
if ($postageoption != 'Normal' && $postageoption !="")
{
...
function disableStuff(){
	if (document.forms.addcustomerdetails.paymentmeth.value == 5){
		for (i = 0; i < 4; i++){
			document.forms.addcustomerdetails.vouchernumber[i].disabled = false;
		}
		document.forms.addcustomerdetails.vouchernumber[0].focus();
	}else{
		for (i = 0; i < 4; i++){
			document.forms.addcustomerdetails.vouchernumber[i].disabled = true;
		}
	}
}
/*
					...
					<td align="left">  
							<table cellpadding="0" cellspacing="0" border="0"> 
								...
								<tr> 
									...
									<td valign="top" class="ordertext">
										<select name="paymentmeth" class="ordertext" id="paymentmeth" onChange="disableStuff();"> 
											...
											<option value="5"<? if($paymentmeth==5){?> selected<? }?>>I will pay using a Gift Voucher.</option> 
										</select> 
									</td> 
								</tr>
								<tr> 
								...
								<tr> 
									...
									<td>
										<input class="smalltext" type="text" name="vouchernumber" size="5" maxlength="3" onKeyDown="JavaScript: return(UpdateVoucherNumber(0, this));" disabled>&nbsp;-&nbsp;
										<input class="smalltext" type="text" name="vouchernumber" size="5" maxlength="3" onKeyDown="JavaScript: return(UpdateVoucherNumber(1, this));" disabled>&nbsp;-&nbsp;
										<input class="smalltext" type="text" name="vouchernumber" size="5" maxlength="3" onKeyDown="JavaScript: return(UpdateVoucherNumber(2, this));" disabled>&nbsp;-&nbsp;
										<input class="smalltext" type="text" name="vouchernumber" size="5" maxlength="3" onKeyDown="JavaScript: return(UpdateVoucherNumber(3, this));" disabled>
									</td>
								</tr> 
								<tr> 
									<td valign="top" class="smalltext">&nbsp;</td> 
