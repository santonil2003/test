...
<html>
<head>
<title>identi Kid - Products - Zip Tags</title>
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="138" bgcolor="#FFFFFF"><h1><span class="headings">Zip 
                          Tags </span></h1></td>
                    ...
                    ?>
                        <div align="right"><strong>
                          ...
                          <!--5 for 
                                  ...
                                  AU$12-->
                          <?= $price_formatted2; ?>
                          </strong><img src="images/spacer_trans.gif" alt="gap" width="10" height="10"></div></td>
                    </tr>
                    <tr valign="top"> 
                      <td colspan="4"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          <tr bgcolor="#FFFFFF"> 
                            ...
                            <td colspan="3" valign="top" class="smalltext"> <div align="center"> 
                                <p><img src="images/ziptags.gif" width="345" height="400"> 
                                </p>
                              </div>
                          ...
                          <tr valign="top"> 
                            <td colspan="3"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  ...
                                  <td class="maintext"><p>Attach these cute PVC 
                                      tags to your zippers.</p>
                                    <p>Great for clothing, pencil cases, keys 
                                      and bags. </p>
                                    </td>
                                </tr>
                              </table></td>
                          ...
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="52%"><a href="order_ziptags.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('add_order','','images/button_add_order_mo.gif',1)"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0""></a></td>
                                </tr>
                              </table>
