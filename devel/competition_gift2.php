...
<html>
<head>
<title>identi Kid - Competition</title>
...
<table width="418" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr valign="top"> 
                      <td bgcolor="6FFF6F"><div align="right"><img src="images/heading_competitions.gif" alt="Our Products" width="167" height="45"></div></td>
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    <tr valign="top" bgcolor="#FFFFFF"> 
                      <td width="418"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                    </tr>
                    <tr valign="top"> 
                      <td> <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          ...
                          <tr valign="top"> 
                            ...
                            <td width="389" class="maintext"><p align="center"><img src="images/giftvoucherinner.gif" width="368" height="374"></p>
                              <p align="center"><strong>TERMS AND CONDITIONS<br>
                                OF IDENTIKID &quot;WIN A $50 GIFT VOUCHER&quot;</strong></p>
                              <ol><li><p>Competition commences on the&nbsp;1st&nbsp;FEBRUARY 2007 at  00.01 AEST and closes on the&nbsp;31st MARCH 2007&nbsp;at 18.00 AEST</p>
                              </li>
                                <li>
                                  <p>Entry is free and automatic to Australian residents spending  $25 with identikid between the the dates specified above. </p>
                                </li>
                                <li>
                                  <p>Directors, employees and associates are not eligible to  enter. </p>
                                </li>
                                <li>
                                  <p>The prize will be delivered Australia wide&nbsp;at the close  of&nbsp;business on 2nd April&nbsp;to the address given by the winning entrant  via Regular mail.</p>
                                </li>
                                <li>
                                  <p>Entry can be done via order placed by phone,fax, mail or  internet.</p>
                                </li>
                                <li>
                                  <p>The&nbsp;10 winners will be drawn on the 1st April 2007.</p>
                                </li>
                                <li>
                                  <p>The winners surname will be published on the Website and  they will be contacted via phone for approval to do so.</p>
                                </li>
                                <li>
                                  <p>The prize is not transferable or redeemable for cash and  must be used within 6 months of recieving voucher.</p>
                                </li>
                                <li>
                                  <p>All information given remain exclusively and confidentially  with identikid. </p>
                                </li>
                                <li>
                                  <p>The promoter is identiBiz pty ltd. </p>
                                </li>
                                <li>
                                  <p>Website address <a href="http://www.identikid.com.au">www.identikid.com.au</a> as per letterhead.</p>
                                </li>
                              </ol>
                            </td>
                          </tr>
