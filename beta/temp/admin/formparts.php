...
/*
function addPictureIbands(){
?>
	
<table border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td colspan="8"><input type="button" name="ClearSelection" value="clear" onClick="JavaScript: ClearIdentiBandSelection();"></td>
  </tr>
  <tr> 
    <td colspan="8"><img src="../images/spacer_trans.gif" height="5" width="1" border="0"></td>
  </tr>
  ...
  <tr> 
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td align="center" class="admintext"><strong>IdentiBand #1</strong></td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td align="center" class="admintext"><strong>IdentiBand #2</strong></td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td align="center" class="admintext"><strong>IdentiBand #3</strong></td>
    <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td align="center" class="admintext"><strong>IdentiBand #4</strong></td>
  </tr>
  <tr> 
    <td colspan="8"><img src="../images/spacer_trans.gif" height="5" width="1" border="0"></td>
  </tr>
  <tr> 
    <td>&nbsp;</td>
    <td align="center" height="60"><img name="Band1" src="../images/spacer_trans.gif" border="0"></td>
    <td>&nbsp;</td>
    <td align="center" height="60"><img name="Band2" src="../images/spacer_trans.gif" border="0"></td>
    <td>&nbsp;</td>
    <td align="center" height="60"><img name="Band3" src="../images/spacer_trans.gif" border="0"></td>
    <td>&nbsp;</td>
    <td align="center" height="60"><img name="Band4" src="../images/spacer_trans.gif" border="0"></td>
  </tr>
  <tr> 
    <td colspan="8"><img src="../images/spacer_trans.gif" height="5" width="1" border="0"></td>
  </tr>
  <tr> 
    <td>&nbsp;</td>
    <td> <select name="IdentiBand1" onChange="JavaScript: UpdateIdentiBandImage(1);">
        <option value="none" selected>[None]</option>
		<option value="U">U - Pink Ballerina</option>
    ...
    <td>&nbsp;</td>
    <td> <select name="IdentiBand2" onChange="JavaScript: UpdateIdentiBandImage(2);">
        <option value="none" selected>[None]</option>
		<option value="U">U - Pink Ballerina</option>
		<option value="Y">Y - Surfer Guy</option>
		<option value="R">R - Truck</option>
    ...
    <td>&nbsp;</td>
    <td> <select name="IdentiBand3" onChange="JavaScript: UpdateIdentiBandImage(3);">
        <option value="none" selected>[None]</option>
 		<option value="U">U - Pink Ballerina</option>
		<option value="Y">Y - Surfer Guy</option>
		<option value="R">R - Truck</option>
    ...
    <td>&nbsp;</td>
    <td> <select name="IdentiBand4" onChange="JavaScript: UpdateIdentiBandImage(4);">
        <option value="none" selected>[None]</option>
		<option value="U">U - Pink Ballerina</option>
		<option value="Y">Y - Surfer Guy</option>
		<option value="R">R - Truck</option>
...
<?	$sql = "SELECT *
			FROM product
			WHERE productName like '%Bands%'";
	$result = mysql_query($sql);
	$iBandProducts = array();
	while ($record = mysql_fetch_array($result)){
		$iBandProducts[] = $record;
	}
?>
  <tr> 
    <td>&nbsp;</td>
    <td>
		<select name="IdentiBandQuantity1">
		<?	foreach ($iBandProducts as $iBandProduct){
				?><option value="<?=$iBandProduct['id']?>"><?=$iBandProduct['productName']?></option><?
			}
		?>
	 	</select>
   <td>&nbsp;</td>
   <td>
		<select name="IdentiBandQuantity2">
		<?	foreach ($iBandProducts as $iBandProduct){
				?><option value="<?=$iBandProduct['id']?>"><?=$iBandProduct['productName']?></option><?
			}
		?>
   ...
   <td>&nbsp;</td>
   <td>
		<select name="IdentiBandQuantity3">
		<?	foreach ($iBandProducts as $iBandProduct){
				?><option value="<?=$iBandProduct['id']?>"><?=$iBandProduct['productName']?></option><?
			}
		?>
    ...
    <td>&nbsp;</td>
    <td>
		<select name="IdentiBandQuantity4">
		<?	foreach ($iBandProducts as $iBandProduct){
				?><option value="<?=$iBandProduct['id']?>"><?=$iBandProduct['productName']?></option><?
			}
		?>
...
<table cellpadding="0" cellspacing="0" border="0">
  ...
  <tr> 
    ...
    <td><img src="../images/spacer_trans.gif" height="1" width="10" border="0"></td>
    <td><input type="radio" name="<?=$packNum;?>pic" value="37"></td>
    <td><img src="../images/pc37.gif" width="50" height="50"></td>
    <td><img src="../images/spacer_trans.gif" height="1" width="10" border="0"></td>
    <td><input type="radio" name="<?=$packNum;?>pic" value="38"></td>
    <td><img src="../images/pc38.gif" width="50" height="50"></td>
    <td><img src="../images/spacer_trans.gif" height="1" width="10" border="0"></td>
    <td><input type="radio" name="<?=$packNum;?>pic" value="39"></td>
    <td><img src="../images/pc39.gif" width="50" height="50"></td>
    <td><img src="../images/spacer_trans.gif" height="1" width="10" border="0"></td>
    <td><input type="radio" name="<?=$packNum;?>pic" value="40"></td>
    <td><img src="../images/pc40.gif" width="50" height="50"></td>
    <td><img src="../images/spacer_trans.gif" height="1" width="10" border="0"></td>
    <td><input type="radio" name="<?=$packNum;?>pic" value="41"></td>
    <td><img src="../images/pc41.gif" width="50" height="50"></td>
    <td><img src="../images/spacer_trans.gif" height="1" width="10" border="0"></td>
    <td><input type="radio" name="<?=$packNum;?>pic" value="42"></td>
    <td><img src="../images/pc42.gif" width="50" height="50"></td>
  </tr>
    <tr> 
    <td height="10" colspan="20"></td>
  </tr>
  <tr> 
    <td><input type="radio" name="<?=$packNum;?>pic" value="43"></td>
    <td><img src="../images/pc43.gif" width="50" height="50"></td>
    <td><img src="../images/spacer_trans.gif" height="1" width="10" border="0"></td>
    <td><input type="radio" name="<?=$packNum;?>pic" value="44"></td>
    <td><img src="../images/pc44.gif" width="50" height="50"></td>
    <td><img src="../images/spacer_trans.gif" height="1" width="10" border="0"></td>
    <td><input type="radio" name="<?=$packNum;?>pic" value="45"></td>
    <td><img src="../images/pc45.gif" width="50" height="42"></td>
    <td><img src="../images/spacer_trans.gif" height="1" width="10" border="0"></td>
    <td><input type="radio" name="<?=$packNum;?>pic" value="46"></td>
    <td><img src="../images/pc46.gif" width="50" height="62"></td>
    <td><img src="../images/spacer_trans.gif" height="1" width="10" border="0"></td>
    <td><input type="radio" name="<?=$packNum;?>pic" value="47"></td>
    <td><img src="../images/pc47.gif" width="50" height="58"></td>
    <td><img src="../images/spacer_trans.gif" height="1" width="10" border="0"></td>
    <td><input type="radio" name="<?=$packNum;?>pic" value="48"></td>
    <td><img src="../images/pc48.gif" width="50" height="61"></td>
    <td><img src="../images/spacer_trans.gif" height="1" width="10" border="0"></td>
    <td><input type="radio" name="<?=$packNum;?>pic" value="49"></td>
    <td><img src="../images/pc49.gif" width="50" height="50"></td>
  </tr>
      <tr> 
    <td height="10" colspan="20"></td>
  </tr>
 <tr> 
    <td><input type="radio" name="<?=$packNum;?>pic" value="50"></td>
    <td><img src="../images/pc50.gif" width="50" height="55"></td>
    <td><img src="../images/spacer_trans.gif" height="1" width="10" border="0"></td>
    <td><input type="radio" name="<?=$packNum;?>pic" value="51"></td>
    <td><img src="../images/pc51.gif" width="50" height="51"></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
