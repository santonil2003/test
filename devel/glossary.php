            ...
            <table width="418" border="0" cellpadding="0" cellspacing="0" bgcolor="#6FFF6F">
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="418" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr valign="top"> 
                      <td bgcolor="6FFF6F"><div align="right"><img src="images/heading_glossary.gif" alt="Glossary" width="167" height="45"></div></td>
                ...
                <td colspan="3" bgcolor="#6FFF6F"> 
                  <table width="418" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    <tr> 
                      ...
                      <td valign="top" bgcolor="#FFFFFF"><p class="maintext"><B>SSL encryption</B> - SSL (Secure Sockets Layer) is the world's most popular method of securing transmission of information between web browsers and websites. SSL requires the use of a certificate that is stored in the web browser, and is authenticated against the web server to provide a secure link between the browser and the website. SSL uses RSA encryption algorithms to achieve the secure link (see above). All information entered into the KUIconnect! chat entry screen is secure via SSL encryption. Most browsers display a gold padlock on the browser status bar (usually located at the bottom of the browser window) to indicate that SSL encryption is enabled. </p>
                        <p class="maintext">&nbsp; </p>
                      <p>&nbsp;</p></td>
