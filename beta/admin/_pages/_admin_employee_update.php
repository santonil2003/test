...
function listItems($startPage, $orderBy, $page)
{
	...
	$lt->rowHtml = '<tr bgcolor="#E5E5E5"><td> <p align="left">{createDate}</p></td><td> <p>{title}</p></td>
                  <td> <p align="center">{getActive()}</p></td><td width="40px" align="center"><a href="index.php?page=a15&id={id}">Edit</a></td>
				  <td width="40px"> <p align="center"><a href="../employee_updates/index.php?id={id}&type=1" target="_blank">View</a></p></td>
				  <td width="40px"> <p align="center"><a href="index.php?page=a6&form_action=DeleteUpdateItem&id={id}" onClick="return confirmDelete();">Delete</a></p></td>
                </tr>';
...
<form name="form1" method="post" action="index.php?page=a17">
          <td width="100%" valign="top">

              <table width="100%" border="0" cellpadding="5">
                <tr bgcolor="#CC0000"> 
                  <td colspan="5"> <p align="left" ><strong><font color="#FFFFFF">Administration 
