...
<html>
<head>
<title>identi Kid - Products - Starter Packs</title>
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="181" bgcolor="#FFFFFF"><h1><span class="headings">Starter  Packs</span></h1></td>
                      ...
                      <td colspan="4"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          ...
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="70%"><div align="center"><img src="images/products_starter_packs.gif" alt="Starter Packs" width="373" height="316"></div></td>
                                </tr>
                              </table>
                            ...
                            <td colspan="3"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  ...
                                  <td class="maintext"><p> 40 vinyls <br>
                                    ...
                                    20 shoe labels <br>
                                    1 identiTag <br>
                                    30 mini labels or 60 pencil labels </p>
                                    <p><strong>Conditions <br>
                                    </strong>Same name, font and picture throughout pack of labels. Font 1, 3 or 4 only. </p>
                                    <p> A great value labelling pack to get you started. Perfect for all ages and uses. </p>
                                    <p>NOTE: When ordering a Starter Pack, you only need to design the vinyl label. We will carry the design onto all of the other name labels in the pack. </p>
                                  </td>
                                </tr>
                              </table></td>
                          </tr>
                          ...
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="52%"><a href="order_starter_packs.php" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('add_order','','images/button_add_order_mo.gif',1)"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0"></a></td>
                                </tr>
                              </table>
							                                <br>                                   
                              <br>
