...
$query = "UPDATE customers SET firstname='".stripslashes($_POST["firstname"])."', surname='".stripslashes($_POST["surname"])."', address='".stripslashes($_POST["address"])."', suburb='".stripslashes($_POST["suburb"])
	."', postcode='".$_POST["postcode"]."', state='".$_POST["state"]."', country='".$_POST["country"]."', emailadd='".addslashes($_POST["emailadd"])."', homephone='".$_POST["homephone"]."', workphone='".$_POST["workphone"]
	."', mobilephone='".$_POST["mobilephone"]."', referral='".stripslashes($_POST["referral"])."', referralcode='".$_POST["referralcode"]."', hear_about='".stripslashes($_POST["hear_about"])
	."', specialreqs='".stripslashes($_POST["specialreqs"])."', postage=".$_POST["postage"].", postage_option='".$_POST["postageoption"]."', paymentmeth=".$_POST["paymentmeth"].", confirmed='".$submittype
