...
<html>
<head>
<title>identi Kid - Products - Magpie Eyes</title>
                    ...
                    <td colspan="4">
                      <table width="100%" border=0 bgcolor="#FFFFFF">
                      	<tr>
                      		...
                      		<td valign="top"><h1 class="headings">Magpie Eyes</h1></td>
                        ...
                        <!--DWLayoutTable-->
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="70%"><div align="center"><img src="images/magpie_eyes_preview.gif" alt="Magpie Eyes" width="270"></div></td>
                                </tr>
                              </table>
                            ...
                            <td> <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                <tr> 
                                  ...
                                  <td class="maintext"><DIV><p><br>
                                    A pack of permanent iron on eyes for their favourite hat<br>
												and a pack of stick ons for single use dots for one off<br>
												temporary use on clothing or permanent on hard surfaces.<br><br>
												<strong>24 magpie eyes for $22-12 stick on and 12 iron on.<br>
												Approx size 45mm per eye.</strong><br><br>
												Black and White eyes to be put onto hat or head covering.
                                      <br>
                                    </p>
                                    </DIV>                                  </td>
                                </tr>
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="52%"><a href="order_magpie_eyes.php"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0"></a></td>
                                </tr>
                              </table>
							                                <br>                                   
                              <br>
