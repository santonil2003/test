...
$query = "SELECT * FROM prices a, currencies b, product c WHERE a.productId=18 AND a.productId=c.id AND a.currencyInt=".$_COOKIE["currency"]." AND a.currencyInt=b.id";
...
<html>
<head>
<title>identi Kid - Order - Vinyl Labels</title>
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="160" bgcolor="#FFFFFF"><h1><span class="headings">Allergy Alert Labels</span></h1></td>
                      ...
                      <td colspan="4"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          ...
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td align=center>
								  <script type="text/javascript" src="javascript/order_allergy_alert.js"></script>
								  </td>
                                </tr>
                              </table></td>
                          </tr>
