...
<html>
<head>
<title>identi Kid - Products -Identi Bands</title>
                ...
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="212" bgcolor="#FFFFFF" class="headings"> 
                        <div align="left">Identi Bands</div></td>
                      <td width="18"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                      <td width="138" bgcolor="#FFFFFF" class="maintext"> 
                        <div align="right"><strong><img src="images/spacer_trans.gif" width="10" height="19"><FONT size=2><FONT face=Arial><strong><? echo $price_formatted."<BR />".$price_formatted2."<BR />".$price_formatted3; ?></strong></FONT></FONT></strong></div></td>
                      ...
                      <td colspan="5"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="70%"><div align="center"><img src="images/products_identibands.gif" width="375" height="386"></div></td>
                                </tr>
                              </table>
                            ...
                            <td> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  ...
                                  <td class="maintext"><ul>
                                    <li> just thread and stick! </li>
                                    <li>great when out in crowds, excursions or to notify others of a childs needs </li>
                                    <li>durable, waterproof material <br>
                                    </li>
                                    </ul></td>
                                </tr>
                              </table></td>
                          ...
                          <tr valign="top"> 
                            <td bgcolor="#FFFFFF"><table width="198" border="0" align="right" cellpadding="0" cellspacing="0">
                                <tr> 
                                  ...
                                  <td width="52%"><a href="order_identibands.php"><img src="images/button_add_order.gif" alt="Add to Order" name="add_order" width="94" height="22" border="0"></a></td>
                                </tr>
                              </table>
							                                <br>                                   
                              <br>
