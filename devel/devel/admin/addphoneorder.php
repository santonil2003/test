...
<body marginheight="0" marginwidth="0" leftmargin="0" rightmargin="0" topmargin="0" bottommargin="0">
	<table cellpadding="0" cellspacing="0" border="0" width="100%" height="100%">
        ...
        <tr> 
          <td align="center">&nbsp; <input type="button" name="Input" value="Add Address Label" onClick="addItem('addresslabels', '<? echo $_GET["startrecord"];?>', '<? echo $_GET["showperpage"];?>');">
            &nbsp; 
            <input type="button" name="Input2" value="Add New Baby Pack" onClick="addItem('newbabypack', '<? echo $_GET["startrecord"];?>', '<? echo $_GET["showperpage"];?>');"></td>
        </tr>
        <tr> 
          ...
          <td class="admintext" align="center"> <strong><?php if ($qdata["type"]!= 30) echo getLabelType($qdata["type"]); ?></strong> 
            <?				// VINYL LABELS
							if($qdata['type']==1 || $qdata['type']==10 || $qdata['type']==11 || $qdata['type']==12){
								...
								elseif ($qdata['type']==11) // mixed
									echo "<BR />30 vinyl name labels and 30 iron-ons<BR /><BR />";
								elseif($qdata['type']==12) // birthday
									echo "<BR />30 vinyls 30 iron-ons Gift card Matching ribbon <BR /><BR />";
								elseif($qdata['type']==10) // birthday
								...
								// Mixed pack details
									...
									if ($qdata['type']==12)
									{
										echo "<BR /><BR /><strong>Gift Card : </strong>".getPicType($qdata['gift']);
									}
									// Starter Packs
									if ($qdata['type']==10)
									{
								...
								// mini vinyls
									...
									{
										$background_colour = $qdata['colour'];
										$font_colour = $qdata['colour'];
									}
