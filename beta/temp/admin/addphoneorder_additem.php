...
function insertSharedPack(){
	...
	$text4 = mysql_real_escape_string($text4);
	$text5 = mysql_real_escape_string($text5);
	$text6 = mysql_real_escape_string($text6);
	$text10 = mysql_real_escape_string($text10);
...
//			exit;
	...
	default:
		...
		//Identitags
			...
			." VALUES (".$id.", ".$price.", '".$quantdesc."', ".$_POST["type"].", ".$typedetail.", ".$pic.", '".mysql_real_escape_string($_POST["text1"])."', '"
			.mysql_real_escape_string($text2)."', '".mysql_real_escape_string($_POST["text3"])."', '".mysql_real_escape_string($_POST["text4"])."', '".mysql_real_escape_string($text5)."', '".$colours."', ".$_POST["font"].", ".$picon.", ".$gift.", ".$split.")";
		}
