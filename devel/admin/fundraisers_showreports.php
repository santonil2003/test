...
$firstPage = ceil((int)$items[0]/100);
...
$first = $last - $per_page;
if($page!=1) $first = $first+1;
if($first < 0) $first = 0;

$query.= " AND ( CAST( idnumber AS SIGNED )  >= {$first} AND CAST(idnumber AS SIGNED)  <= {$last} ) ORDER BY idnumber";
//echo $query;
$result = mysql_query($query);
if(!$result) error_message(sql_error());
...
if($Q2)
{
	?>
							<tr class="admintext">
								...
								<td nowrap align="left" width=60 class="Q1admintext"><strong>&#37;</strong></td>
								<td class="Q1admintext"><img src="../images/spacer_trans.gif" height="1" width="1" border="0"></td>
	...
	?>
							<tr class="admintext">
								...
								<td><img src="../images/spacer_trans.gif" height="1" width="1" border="0"></td>
								<td nowrap align="left"><strong>GST</strong></td>
								<? if($type=="quarter"){?>
								<td><img src="../images/spacer_trans.gif" height="1" width="1" border="0"></td>
...
// display schools.
						if($Q2==TRUE)
						{
							...
							while($qdata = mysql_fetch_array($result)){
									...
									$totalProductCost = getCommissionProductCostFromRecSummary($result2);
									list($sentStat, $commPercentage) = getSentStat($qdata["id"], $yr, $quart);
									if(!$commPercentage){ $commPercentage = $qdata["percentage"]; }
									$commission = $totalProductCost*($commPercentage/100);
									...
									$totalQ2ProductCost = getCommissionProductCostFromRecSummary($Q2result);
									list($Q2sentStat, $Q2CommPercentage)  = getSentStat($qdata["id"], $Q2yr, $Q2quart);
									if(!$Q2CommPercentage){ $Q2CommPercentage = $qdata["percentage"]; }
									$Q2commission = $totalQ2ProductCost*($Q2CommPercentage/100);
							...
							if($gt==false || $gt=='false'  || $grandTotal > $gt) {
							?>
							...
							<tr class="admintext">
								...
								<td><img src="../images/spacer_trans.gif" height="1" width="1" border="0"></td>
								<td align="left" class="Q1admintext"><? echo "$".sprintf("%01.2f", $totalProductCost);?></td>
								<td class="Q1admintext"><img src="../images/spacer_trans.gif" height="1" width="1" border="0"></td>
								<td align="left" class="Q1admintext"><? echo sprintf("%01.2f", $commPercentage)."%";?></td>
								<td class="Q1admintext"><img src="../images/spacer_trans.gif" height="1" width="1" border="0"></td>
								...
								<td><img src="../images/spacer_trans.gif" height="1" width="1" border="0"></td>
								<td align="left" class="Q2admintext"><? echo "$".sprintf("%01.2f", $totalQ2ProductCost);?></td>
								<td class="Q2admintext"><img src="../images/spacer_trans.gif" height="1" width="1" border="0"></td>
								<td align="left" class="Q1admintext"><? echo sprintf("%01.2f", $Q2CommPercentage)."%";?></td>
								<td class="Q1admintext"><img src="../images/spacer_trans.gif" height="1" width="1" border="0"></td>
							...
							while($qdata = mysql_fetch_array($result)){
							      ...
							      */
						if($gt==false || $gt=='false' || $commission > $gt) {
							...
							<tr class="admintext">
								...
								<td><img src="../images/spacer_trans.gif" height="1" width="1" border="0"></td>
								<td align="left"><? echo sprintf("%01.2f", $commPercentage)."%";?></td>
								<td><img src="../images/spacer_trans.gif" height="1" width="1" border="0"></td>
								<td align="left"><? echo "$".sprintf("%01.2f", $commission);?></td>
								<td><img src="../images/spacer_trans.gif" height="1" width="1" border="0"></td>
								<td align="left"><? echo "$".sprintf("%01.2f", $GST);?></td>
								<? if($type=="quarter"){?>
								<td><img src="../images/spacer_trans.gif" height="1" width="1" border="0"></td>
								<td align="left">
								<? 	if($sentStat){
