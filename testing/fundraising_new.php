											...
											<img src="images/gen/spacer.gif" width="378" height="7" alt=""><br>
												<table border="0" cellspacing="0" cellpadding="0" width="378">
													<tr>
														...
														<!-- content area -->
														<img src="images/heads/h_fundraisers.gif" alt="" width="362" height="57" border="0"><br>
														<img src="images/gen/spacer.gif" width="1" height="5" alt=""><br>	
					  										<table width="100%" border="0" cellspacing="0" cellpadding="0">
										                        <tr> 
										                            <td class="maintext"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="362" height="64">
									                                <param name="movie" value="images/plane_flies.swf">
									                                <param name="quality" value="high">					
									                                <embed src="images/plane_flies.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="362" height="64"></embed></object></td>
										                        </tr>
															</table>
											                    ...
											                    <tr>
											                    	<td class="maintext"> 
											                        	<table width="100%" border="0" cellspacing="0" cellpadding="0">
											                            	<tr>
												                                <td>
																				<form name="form1" method="post" action="submitfundraising.php" onSubmit="return validateForm();">
												                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
												                                        <tr> 
																		...
																		<br><br>
																			<table width="200">
																				<tr> 
																					<td colspan="2" valign="middle"><img src="images/spacer_trans.gif" width="1" height="50"><br></td>
																			  	</tr>
																			</table>
																					<? }?>
