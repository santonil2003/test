...
<html>
<head>
<title>identi Kid - Order - Birthday Packs</title>
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="160" bgcolor="#FFFFFF"><h1><span class="headings">Birthday 
                        Packs</span></h1></td>
                    ...
                    <tr valign="top"> 
                      <td colspan="4"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                          <tr bgcolor="#FFFFFF"> 
                            ...
                            <td width="244" valign="top" class="smalltext"><table width="212" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
                                  <td width="10" class="smalltext"><img src="images/spacer_trans.gif" width="10" height="10"></td>
                                  <td width="202" class="smalltext"><div align="left">(The 
                                      perfect gift!)</div></td>
                                </tr>
                              </table></td>
                          ...
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
								 ...
								 WIDTH="350" HEIGHT="1600" id="prod" ALIGN="">
<PARAM NAME=movie VALUE="images/order_birthday_pack.swf?type=12&amp;v=071004">
								  <PARAM NAME=quality VALUE=high>
								  <PARAM NAME=bgcolor VALUE=#FFFFFF>
								  <EMBED src="images/order_birthday_pack.swf?type=12&v=071004" quality=high bgcolor=#FFFFFF  WIDTH="350" HEIGHT="1600" NAME="prod" ALIGN=""
