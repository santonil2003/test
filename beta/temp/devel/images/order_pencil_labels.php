...
<html>
<head>
<title>identi Kid - Order - Pencil Labels</title>
              ...
              <tr valign="top"> 
                <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="FFFFFF">
                    ...
                    <tr valign="top"> 
                      ...
                      <td width="160" bgcolor="#FFFFFF"><h1><span class="headings">Pencil 
                        Labels</td>
                          ...
                          <tr valign="top"> 
                            <td colspan="3" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr> 
								 ...
								 WIDTH="350" HEIGHT="620" ALIGN="">
								  <PARAM NAME=movie VALUE="images/order_pencil_labels.swf?v=300904">
								  <PARAM NAME=quality VALUE=high>
								  <PARAM NAME=bgcolor VALUE=#FFFFFF>
								  <EMBED src="images/order_pencil_labels.swf?v=300904" quality=high bgcolor=#FFFFFF  WIDTH="350" HEIGHT="620" ALIGN=""
